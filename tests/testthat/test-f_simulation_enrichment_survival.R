...
test_that("'getSimulationEnrichmentSurvival': gMax = 2", {
	...
	expect_equal(unlist(as.list(simResult1$singleEventsPerSubsetAndStage)), c(6.4000002, 12.8, 6.9157979, 13.831596, 7.4434489, 14.886898, 7.9849789, 15.969958, 8.5428984, 17.085797, 9.1204104, 18.240821, 9.7216794, 19.443359, 33.6, 67.2, 33.084202, 66.168404, 32.556551, 65.113102, 32.015021, 64.030042, 31.457102, 62.914203, 30.87959, 61.759179, 30.278321, 60.556641), tolerance = 1e-07, label = paste0("c(", paste0(unlist(as.list(simResult1$singleEventsPerSubsetAndStage)), collapse = ", "), ")"))
	...
	expect_equal(unlist(as.list(simResult2$singleEventsPerSubsetAndStage)), c(6.4000002, 12.8, 6.9157979, 13.831596, 7.4434489, 14.886898, 7.9849789, 15.969958, 8.5428984, 17.085797, 9.1204104, 18.240821, 9.7216794, 19.443359, 33.6, 67.2, 33.084202, 66.168404, 32.556551, 65.113102, 32.015021, 64.030042, 31.457102, 62.914203, 30.87959, 61.759179, 30.278321, 60.556641), tolerance = 1e-07, label = paste0("c(", paste0(unlist(as.list(simResult2$singleEventsPerSubsetAndStage)), collapse = ", "), ")"))
	...
	expect_equal(unlist(as.list(simResult4$singleEventsPerSubsetAndStage)), c(14.163599, 41.987823, 15.080284, 51.115783, 16, 53.626374, 16.925752, 54.19654, 17.861157, 63.084929, 18.810731, 68.25655, 19.780244, 66.330305, 25.836401, 38.012177, 24.919716, 28.884217, 24, 26.373626, 23.074248, 25.80346, 22.138843, 16.915071, 21.189269, 11.74345, 20.219756, 13.669695), tolerance = 1e-07, label = paste0("c(", paste0(unlist(as.list(simResult4$singleEventsPerSubsetAndStage)), collapse = ", "), ")"))
...
test_that("'getSimulationEnrichmentSurvival': gMax = 3", {
	...
	expect_equal(unlist(as.list(simResult5$singleEventsPerSubsetAndStage)), c(3.6945761, 3.7323515, 1.6794688, 3.6346639, 3.3378849, 1.5777994, 4.1778232, 4.109865, 2.0374383, 4.1120508, 5.0603333, 2.5559297, 8.6108478, 7.5016338, 3.8269345, 8.4712121, 8.1386608, 4.0963486, 8.3556464, 7.4828019, 3.6874504, 8.2241016, 5.8022236, 2.8385927, 5.5418642, 7.9479841, 4.2029806, 5.4519959, 7.2779689, 3.7763732, 5.3776189, 7.4046555, 3.8364399, 5.2929579, 8.236505, 4.1905719, 2.1527119, 0.81803054, 0.29061611, 2.4421281, 1.2454853, 0.54947882, 2.0889116, 1.0026776, 0.43867143, 2.3708897, 0.90093809, 0.4149057), tolerance = 1e-07, label = paste0("c(", paste0(unlist(as.list(simResult5$singleEventsPerSubsetAndStage)), collapse = ", "), ")"))
...
test_that("'getSimulationEnrichmentSurvival': gMax = 4", {
	...
	expect_equal(unlist(as.list(simResult3$singleEventsPerSubsetAndStage)), c(1.7600545, 1.5465305, 2.0147151, 1.9724525, 6.6217708, 5.219482, 13.921345, 14.858066, 8.8002727, 9.3924133, 17.28183, 18.444665, 41.737343, 44.545708, 7.8626685, 4.0206827), tolerance = 1e-07, label = paste0("c(", paste0(unlist(as.list(simResult3$singleEventsPerSubsetAndStage)), collapse = ", "), ")"))
	...
	expect_equal(unlist(as.list(simResult4$singleEventsPerSubsetAndStage)), c(1.7600545, 1.5465305, 2.0147151, 1.9724525, 6.6217708, 5.219482, 13.921345, 14.858066, 8.8002727, 9.3924133, 17.28183, 18.444665, 41.737343, 44.545708, 7.8626685, 4.0206827), tolerance = 1e-07, label = paste0("c(", paste0(unlist(as.list(simResult4$singleEventsPerSubsetAndStage)), collapse = ", "), ")"))
