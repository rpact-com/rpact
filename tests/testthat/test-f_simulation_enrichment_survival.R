...
test_that("'getSimulationEnrichmentSurvival': gMax = 2", {
	...
	expect_equal(unlist(as.list(simResult1$singleEventsPerPopulationAndStage)), c(6.4000002, 12.8, 6.9157979, 13.831596, 7.4434489, 14.886898, 7.9849789, 15.969958, 8.5428984, 17.085797, 9.1204104, 18.240821, 9.7216794, 19.443359, 33.6, 67.2, 33.084202, 66.168404, 32.556551, 65.113102, 32.015021, 64.030042, 31.457102, 62.914203, 30.87959, 61.759179, 30.278321, 60.556641), tolerance = 1e-07, label = paste0("c(", paste0(unlist(as.list(simResult1$singleEventsPerPopulationAndStage)), collapse = ", "), ")"))
	...
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    ...
	    expect_equal(simResult1CodeBased$singleEventsPerPopulationAndStage, simResult1$singleEventsPerPopulationAndStage, tolerance = 1e-07)
	...
	expect_equal(unlist(as.list(simResult2$singleEventsPerPopulationAndStage)), c(6.4000002, 12.8, 6.9157979, 13.831596, 7.4434489, 14.886898, 7.9849789, 15.969958, 8.5428984, 17.085797, 9.1204104, 18.240821, 9.7216794, 19.443359, 33.6, 67.2, 33.084202, 66.168404, 32.556551, 65.113102, 32.015021, 64.030042, 31.457102, 62.914203, 30.87959, 61.759179, 30.278321, 60.556641), tolerance = 1e-07, label = paste0("c(", paste0(unlist(as.list(simResult2$singleEventsPerPopulationAndStage)), collapse = ", "), ")"))
	...
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    ...
	    expect_equal(simResult2CodeBased$singleEventsPerPopulationAndStage, simResult2$singleEventsPerPopulationAndStage, tolerance = 1e-07)
	...
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    ...
	    expect_equal(simResult3CodeBased$singleEventsPerPopulationAndStage, simResult3$singleEventsPerPopulationAndStage, tolerance = 1e-07)
	...
	expect_equal(unlist(as.list(simResult4$singleEventsPerPopulationAndStage)), c(14.163599, 41.987823, 15.080284, 51.115783, 16, 53.626374, 16.925752, 54.19654, 17.861157, 63.084929, 18.810731, 68.25655, 19.780244, 66.330305, 25.836401, 38.012177, 24.919716, 28.884217, 24, 26.373626, 23.074248, 25.80346, 22.138843, 16.915071, 21.189269, 11.74345, 20.219756, 13.669695), tolerance = 1e-07, label = paste0("c(", paste0(unlist(as.list(simResult4$singleEventsPerPopulationAndStage)), collapse = ", "), ")"))
	...
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    ...
	    expect_equal(simResult4CodeBased$singleEventsPerPopulationAndStage, simResult4$singleEventsPerPopulationAndStage, tolerance = 1e-07)
...
test_that("'getSimulationEnrichmentSurvival': gMax = 3", {
	...
	expect_equal(unlist(as.list(simResult1$singleEventsPerPopulationAndStage)), c(3.6197209, 3.2915498, 1.6457749, 3.5373259, 3.2717967, 1.6358983, 4.2198086, 3.8135488, 1.9067744, 4.1271956, 5.2358276, 2.6179138, 8.7605581, 7.6271207, 3.8135604, 8.5611432, 8.0506265, 4.0253132, 8.4396172, 7.6333921, 3.816696, 8.2543912, 5.4792526, 2.7396263, 5.4295814, 8.6871044, 4.3435522, 5.3059889, 7.509583, 3.7547915, 5.23067, 7.9411869, 3.9705935, 5.1158714, 8.7093352, 4.3546676, 2.1901395, 0.39422512, 0.19711256, 2.595542, 1.1679939, 0.58399695, 2.1099043, 0.61187224, 0.30593612, 2.5025418, 0.57558462, 0.28779231), tolerance = 1e-07, label = paste0("c(", paste0(unlist(as.list(simResult1$singleEventsPerPopulationAndStage)), collapse = ", "), ")"))
	...
	expect_equal(unlist(as.list(simResult2$singleEventsPerPopulationAndStage)), c(3.6197209, 3.7506414, 1.8718405, 3.5373259, 3.63547, 1.8142515, 4.2198086, 4.2827326, 2.1395276, 4.1271956, 4.2345201, 2.1156817, 8.7605581, 9.0774157, 4.5302851, 8.5611432, 8.7986745, 4.3909064, 8.4396172, 8.5654651, 4.2790552, 8.2543912, 8.4690401, 4.2313635, 5.4295814, 5.625962, 2.8077608, 5.3059889, 5.453205, 2.7213772, 5.23067, 5.3086675, 2.6520546, 5.1158714, 5.2489056, 2.6224964, 2.1901395, 1.5459808, 0.79011363, 2.595542, 2.1126504, 1.0734649, 2.1099043, 1.8431348, 0.9293626, 2.5025418, 2.0475342, 1.0304584), tolerance = 1e-07, label = paste0("c(", paste0(unlist(as.list(simResult2$singleEventsPerPopulationAndStage)), collapse = ", "), ")"))
	...
	expect_equal(unlist(as.list(simResult3$singleEventsPerPopulationAndStage)), c(3.6197209, 3.780682, 1.6893108, 3.5373259, 3.2506085, 1.5558983, 4.2198086, 4.1738404, 2.0706939, 4.1271956, 5.1472378, 2.6010146, 8.7605581, 7.5733107, 3.8740056, 8.5611432, 8.2799243, 4.1487871, 8.4396172, 7.5735103, 3.7333396, 8.2543912, 5.8114801, 2.8436611, 5.4295814, 7.8137543, 4.1410147, 5.3059889, 7.1716962, 3.7113176, 5.23067, 7.2398952, 3.7528866, 5.1158714, 8.140367, 4.1424049, 2.1901395, 0.83225302, 0.29566884, 2.595542, 1.297771, 0.58399695, 2.1099043, 1.0127541, 0.4430799, 2.5025418, 0.90091505, 0.4129194), tolerance = 1e-07, label = paste0("c(", paste0(unlist(as.list(simResult3$singleEventsPerPopulationAndStage)), collapse = ", "), ")"))
	...
	expect_equal(unlist(as.list(simResult5$singleEventsPerPopulationAndStage)), c(3.6945761, 3.7323515, 1.6794688, 3.6346639, 3.3378849, 1.5777994, 4.1778232, 4.109865, 2.0374383, 4.1120508, 5.0603333, 2.5559297, 8.6108478, 7.5016338, 3.8269345, 8.4712121, 8.1386608, 4.0963486, 8.3556464, 7.4828019, 3.6874504, 8.2241016, 5.8022236, 2.8385927, 5.5418642, 7.9479841, 4.2029806, 5.4519959, 7.2779689, 3.7763732, 5.3776189, 7.4046555, 3.8364399, 5.2929579, 8.236505, 4.1905719, 2.1527119, 0.81803054, 0.29061611, 2.4421281, 1.2454853, 0.54947882, 2.0889116, 1.0026776, 0.43867143, 2.3708897, 0.90093809, 0.4149057), tolerance = 1e-07, label = paste0("c(", paste0(unlist(as.list(simResult5$singleEventsPerPopulationAndStage)), collapse = ", "), ")"))
	...
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    ...
	    expect_equal(simResult5CodeBased$singleEventsPerPopulationAndStage, simResult5$singleEventsPerPopulationAndStage, tolerance = 1e-07)
...
test_that("'getSimulationEnrichmentSurvival': gMax = 4", {
	...
	expect_equal(unlist(as.list(simResult1$singleEventsPerPopulationAndStage)), c(7.8947368, 5.6940341, 4.6052632, 3.8122818, 10.526316, 7.8604058, 17.763158, 18.4485, 7.8947368, 7.9435029, 13.815789, 14.40569, 31.578947, 39.230322, 5.9210526, 2.6052632), tolerance = 1e-07, label = paste0("c(", paste0(unlist(as.list(simResult1$singleEventsPerPopulationAndStage)), collapse = ", "), ")"))
	...
	expect_equal(unlist(as.list(simResult2$singleEventsPerPopulationAndStage)), c(7.8947368, 6.4805425, 4.6052632, 4.5696194, 10.526316, 8.690946, 17.763158, 19.390381, 7.8947368, 8.6179471, 13.815789, 15.081407, 31.578947, 34.471788, 5.9210526, 2.6973684), tolerance = 1e-07, label = paste0("c(", paste0(unlist(as.list(simResult2$singleEventsPerPopulationAndStage)), collapse = ", "), ")"))
	...
	expect_equal(unlist(as.list(simResult3$singleEventsPerPopulationAndStage)), c(1.7600545, 1.5465305, 2.0147151, 1.9724525, 6.6217708, 5.219482, 13.921345, 14.858066, 8.8002727, 9.3924133, 17.28183, 18.444665, 41.737343, 44.545708, 7.8626685, 4.0206827), tolerance = 1e-07, label = paste0("c(", paste0(unlist(as.list(simResult3$singleEventsPerPopulationAndStage)), collapse = ", "), ")"))
	...
	expect_equal(unlist(as.list(simResult4$singleEventsPerPopulationAndStage)), c(1.7600545, 1.5465305, 2.0147151, 1.9724525, 6.6217708, 5.219482, 13.921345, 14.858066, 8.8002727, 9.3924133, 17.28183, 18.444665, 41.737343, 44.545708, 7.8626685, 4.0206827), tolerance = 1e-07, label = paste0("c(", paste0(unlist(as.list(simResult4$singleEventsPerPopulationAndStage)), collapse = ", "), ")"))
