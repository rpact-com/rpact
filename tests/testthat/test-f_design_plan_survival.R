...
test_that("'getSampleSizeSurvival': Sample size calculation of survival designs for one sided group sequential design and typeOfComputation = 'Schoenfeld'", {
	...
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 14.542817, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 36.357042, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[3, ], 72.714085, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
	...
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 17.235931, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 43.089828, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[3, ], 86.179656, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
	...
	expect_equal(sampleSizeResult$informationRates[2, ], 0.5, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$informationRates[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$informationRates[3, ], 1, label = paste0("c(", paste0(sampleSizeResult$informationRates[3, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 21.254997, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 53.137492, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[3, ], 106.27498, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
	...
	expect_equal(sampleSizeResult$informationRates[2, ], 0.5, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$informationRates[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$informationRates[3, ], 1, label = paste0("c(", paste0(sampleSizeResult$informationRates[3, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 28.339996, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 70.849989, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[3, ], 141.69998, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
	...
	expect_equal(sampleSizeResult$maxStudyDuration, 18, label = paste0("c(", paste0(sampleSizeResult$maxStudyDuration, collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 12.926948, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 32.317371, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[3, ], 64.634742, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
	...
	expect_equal(sampleSizeResult$maxStudyDuration, 18, label = paste0("c(", paste0(sampleSizeResult$maxStudyDuration, collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 21.747749, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 54.369372, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[3, ], 108.73874, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
...
test_that("'getSampleSizeSurvival': sample size calculation of survival designs for one sided group sequential design and typeOfComputation = 'Freedman'", {
	...
	expect_equal(sampleSizeResult$informationRates[2, ], 0.5, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$informationRates[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$informationRates[3, ], 1, label = paste0("c(", paste0(sampleSizeResult$informationRates[3, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 14.429462, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 36.073656, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[3, ], 72.147312, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
	...
	expect_equal(sampleSizeResult$informationRates[2, ], 0.5, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$informationRates[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$informationRates[3, ], 1, label = paste0("c(", paste0(sampleSizeResult$informationRates[3, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 27.519117, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 68.797794, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[3, ], 137.59559, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
	...
	expect_equal(sampleSizeResult$maxStudyDuration, 18, label = paste0("c(", paste0(sampleSizeResult$maxStudyDuration, collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 12.554152, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 31.385379, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[3, ], 62.770758, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
...
test_that("'getSampleSizeSurvival': sample size calculation of survival designs for one sided group sequential design and typeOfComputation = 'HsiehFreedman'", {
	...
	expect_equal(sampleSizeResult$informationRates[2, ], 0.5, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$informationRates[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$informationRates[3, ], 1, label = paste0("c(", paste0(sampleSizeResult$informationRates[3, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 19.239283, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 48.098208, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[3, ], 96.196416, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
	...
	expect_equal(sampleSizeResult$studyDuration, 13.802401, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$studyDuration, collapse = ", "), ")"))
	expect_equal(sampleSizeResult$maxStudyDuration, 18, label = paste0("c(", paste0(sampleSizeResult$maxStudyDuration, collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 14.763979, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 36.909947, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[3, ], 73.819895, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
...
test_that("'getSampleSizeSurvival': sample size calculation of survival data for two sided group sequential design and typeOfComputation = 'Schoenfeld'", {
	...
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 6.1538138, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 15.384534, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[3, ], 30.769069, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
	...
	expect_equal(sampleSizeResult$rejectPerStage[3, ], 0.23711559, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$rejectPerStage[3, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$earlyStop, 0.66288441, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$earlyStop, collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 8.205085, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 20.512713, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[3, ], 41.025425, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
	...
	expect_equal(sampleSizeResult$maxStudyDuration, 18, label = paste0("c(", paste0(sampleSizeResult$maxStudyDuration, collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 6.2964769, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 15.741192, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[3, ], 31.482385, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
...
test_that("'getSampleSizeSurvival': sample size calculation of survival data for two sided group sequential design and typeOfComputation = 'Freedman'", {
	...
	expect_equal(sampleSizeResult$maxStudyDuration, 18, label = paste0("c(", paste0(sampleSizeResult$maxStudyDuration, collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 8.6488004, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 21.622001, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[3, ], 43.244002, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
	...
	expect_equal(sampleSizeResult$rejectPerStage[3, ], 0.28314367, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$rejectPerStage[3, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$earlyStop, 0.61685633, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$earlyStop, collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 16.494541, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 41.236352, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[3, ], 82.472703, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
	...
	expect_equal(sampleSizeResult$maxStudyDuration, 18, label = paste0("c(", paste0(sampleSizeResult$maxStudyDuration, collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 7.5247676, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 18.811919, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[3, ], 37.623838, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
...
test_that("'getSampleSizeSurvival': sample size calculation of survival data for two sided group sequential design and typeOfComputation = 'HsiehFreedman'", {
	...
	expect_equal(sampleSizeResult$maxStudyDuration, 18, label = paste0("c(", paste0(sampleSizeResult$maxStudyDuration, collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 11.531734, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 28.829335, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[3, ], 57.658669, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
	...
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], c(33.402728, 11.531734), tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], c(83.50682, 28.829335), tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[3, ], c(167.01364, 57.658669), tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
	...
	expect_equal(sampleSizeResult$maxStudyDuration, 18, label = paste0("c(", paste0(sampleSizeResult$maxStudyDuration, collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 33.402728, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 83.50682, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[3, ], 167.01364, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
...
test_that("'getSampleSizeSurvival': Effect size is based on event rate at specified event time for the reference group and hazard ratio", {
	...
	expect_equal(sampleSizeResult$maxStudyDuration, 18, label = paste0("c(", paste0(sampleSizeResult$maxStudyDuration, collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 32.927229, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 65.854457, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
...
test_that("'getSampleSizeSurvival': Specification of piecewise exponential survival time and hazard ratios", {
	...
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], c(96.227483, 45.789578, 32.927229), tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], c(192.45497, 91.579156, 65.854457), tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
...
test_that("'getSampleSizeSurvival': Specification of piecewise exponential survival time for both treatment arms", {
	...
	expect_equal(sampleSizeResult$maxStudyDuration, 18, label = paste0("c(", paste0(sampleSizeResult$maxStudyDuration, collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[1, ], 96.227483, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(sampleSizeResult$cumulativeEventsPerStage[2, ], 192.45497, tolerance = 1e-07, label = paste0("c(", paste0(sampleSizeResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
...
test_that("'getPowerSurvival': Power calculation of survival designs for one-sided group sequential design", {
	...
	expect_equal(powerResult$cumulativeEventsPerStage[1, ], 13.5, tolerance = 1e-07, label = paste0("c(", paste0(powerResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(powerResult$cumulativeEventsPerStage[2, ], 31.5, tolerance = 1e-07, label = paste0("c(", paste0(powerResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(powerResult$cumulativeEventsPerStage[3, ], 45, label = paste0("c(", paste0(powerResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
	...
	expect_equal(powerResult$cumulativeEventsPerStage[1, ], 19.5, tolerance = 1e-07, label = paste0("c(", paste0(powerResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(powerResult$cumulativeEventsPerStage[2, ], 45.5, tolerance = 1e-07, label = paste0("c(", paste0(powerResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(powerResult$cumulativeEventsPerStage[3, ], 65, label = paste0("c(", paste0(powerResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
...
test_that("'getPowerSurvival': Power calculation of survival designs for two-sided group sequential design", {
	...
	expect_equal(powerResult$cumulativeEventsPerStage[1, ], 16.5, tolerance = 1e-07, label = paste0("c(", paste0(powerResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(powerResult$cumulativeEventsPerStage[2, ], 38.5, tolerance = 1e-07, label = paste0("c(", paste0(powerResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(powerResult$cumulativeEventsPerStage[3, ], 55, label = paste0("c(", paste0(powerResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
...
test_that("'getPowerSurvival': Four stage O'Brien and Fleming group sequential design with minimum required definitions, pi1 = c(0.4, 0.5, 0.6) and pi2 = 0.2 at event time 12, accrual time 12 and follow-up time 6 as default", {
	...
	expect_equal(powerResult$cumulativeEventsPerStage[1, ], 10, label = paste0("c(", paste0(powerResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(powerResult$cumulativeEventsPerStage[2, ], 20, label = paste0("c(", paste0(powerResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
	expect_equal(powerResult$cumulativeEventsPerStage[3, ], 30, label = paste0("c(", paste0(powerResult$cumulativeEventsPerStage[3, ], collapse = ", "), ")"))
	expect_equal(powerResult$cumulativeEventsPerStage[4, ], 40, label = paste0("c(", paste0(powerResult$cumulativeEventsPerStage[4, ], collapse = ", "), ")"))
...
test_that("'getPowerSurvival': Specify effect size for a two-stage group design with O'Brien & Fleming boundaries Effect size is based on event rates at specified event time, directionUpper = FALSE needs to be specified because it should be shown that hazard ratio < 1", {
	...
	expect_equal(powerResult$cumulativeEventsPerStage[1, ], 20, label = paste0("c(", paste0(powerResult$cumulativeEventsPerStage[1, ], collapse = ", "), ")"))
	expect_equal(powerResult$cumulativeEventsPerStage[2, ], 40, label = paste0("c(", paste0(powerResult$cumulativeEventsPerStage[2, ], collapse = ", "), ")"))
