...
test_that("'getSimulationSurvival': configuration 1", {
	...
	expect_equal(simulationResults$median1, c(37.275405, 23.320299, 16.282985, 12), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$median1, collapse = ", "), ")"))
	expect_equal(simulationResults$median2, 37.275405, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$median2, collapse = ", "), ")"))
	expect_equal(simulationResults$accrualIntensity, c(9.5238095, 19.047619, 19.047619), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$accrualIntensity, collapse = ", "), ")"))
	expect_equal(simulationResults$lambda1, c(0.018595296, 0.029722912, 0.042568802, 0.057762265), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$lambda1, collapse = ", "), ")"))
	expect_equal(simulationResults$lambda2, 0.018595296, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$lambda2, collapse = ", "), ")"))
	expect_equal(simulationResults$hazardRatio, c(1, 1.5984103, 2.2892242, 3.1062837), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$hazardRatio, collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[1, ], c(22.223223, 18.818775, 16.321595, 14.790808), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$studyDuration, c(22.223223, 18.818775, 16.321595, 14.790808), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[1, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResults$eventsNotAchieved[1, ], collapse = ", "), ")"))
	...
	expect_equal(simulationResults$overallReject, c(0.01, 0.41, 0.81, 1), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$overallReject, collapse = ", "), ")"))
	...
	expect_equal(simulationResults$rejectPerStage[1, ], c(0.01, 0.41, 0.81, 1), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$earlyStop, c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResults$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfSubjects, c(200, 200, 200, 200), label = paste0("c(", paste0(simulationResults$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfEvents, c(50, 50, 50, 50), label = paste0("c(", paste0(simulationResults$expectedNumberOfEvents, collapse = ", "), ")"))
...
test_that("'getSimulationSurvival': configuration 2", {
	...
	## Comparison of the results of SimulationResultsSurvival object 'simulationResults' with expected results
	expect_equal(simulationResults$median1, c(23.320299, 19.308487, 16.282985, 13.9131), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$median1, collapse = ", "), ")"))
	expect_equal(simulationResults$median2, 9.0776496, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$median2, collapse = ", "), ")"))
	expect_equal(simulationResults$accrualIntensity, c(23.809524, 47.619048, 47.619048), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$accrualIntensity, collapse = ", "), ")"))
	expect_equal(simulationResults$lambda1, c(0.029722912, 0.035898576, 0.042568802, 0.04981975), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$lambda1, collapse = ", "), ")"))
	expect_equal(simulationResults$lambda2, 0.076357561, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$lambda2, collapse = ", "), ")"))
	expect_equal(simulationResults$hazardRatio, c(0.38925958, 0.47013781, 0.55749295, 0.6524534), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$hazardRatio, collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[1, ], c(5.4183926, 5.2945044, 5.1495619, 5.0392001), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[2, ], c(10.130549, 10.39649, 10.458778, 9.7641943), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[3, ], c(13.506679, 14.455396, 18.382917, 18.866629), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[3, ], collapse = ", "), ")"))
	expect_equal(simulationResults$studyDuration, c(8.500396, 9.4448778, 11.628285, 12.227203), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[1, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResults$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[2, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResults$eventsNotAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[3, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResults$eventsNotAchieved[3, ], collapse = ", "), ")"))
	...
	expect_equal(simulationResults$overallReject, c(1, 0.93, 0.96, 0.69), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$overallReject, collapse = ", "), ")"))
	expect_gte(object = simulationResults$overallReject[1], expected = 0)
	expect_gte(object = simulationResults$overallReject[2], expected = 0)
	expect_gte(object = simulationResults$overallReject[3], expected = 0)
	expect_gte(object = simulationResults$overallReject[4], expected = 0)
	...
	expect_lte(object = simulationResults$overallReject[3], expected = 1)
	expect_lte(object = simulationResults$overallReject[4], expected = 1)
	expect_equal(simulationResults$rejectPerStage[1, ], c(0.4, 0.21, 0.2, 0.13), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$rejectPerStage[2, ], c(0.55, 0.63, 0.5, 0.15), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$rejectPerStage[3, ], c(0.05, 0.09, 0.26, 0.41), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[3, ], collapse = ", "), ")"))
	expect_equal(simulationResults$futilityStop, c(0, 0.07, 0.02, 0.26), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$futilityStop, collapse = ", "), ")"))
	expect_equal(simulationResults$futilityPerStage[1, ], c(0, 0.06, 0.02, 0.22), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$futilityPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$futilityPerStage[2, ], c(0, 0.01, 0, 0.04), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$futilityPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$earlyStop, c(0.95, 0.91, 0.72, 0.54), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfSubjects, c(319.3515, 359.96969, 385.19188, 358.56277), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfEvents, c(62.22, 80.58, 119.09, 138.58), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$expectedNumberOfEvents, collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_, NA_real_), label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[2, ], c(0.61612368, 0.57564124, 0.49458667, 0.52832804), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[3, ], c(0.78816558, 0.77803263, 0.64572713, 0.66129837), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[3, ], collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    invisible(capture.output(expect_error(print(simulationResults), NA)))
	    expect_output(print(simulationResults)$show())
	    invisible(capture.output(expect_error(summary(simulationResults), NA)))
...
test_that("'getSimulationSurvival': configuration 3", {
	...
	expect_equal(simulationResults$lambda1, c(0.029722912, 0.035898576, 0.042568802, 0.04981975), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$lambda1, collapse = ", "), ")"))
	expect_equal(simulationResults$lambda2, 0.018595296, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$lambda2, collapse = ", "), ")"))
	expect_equal(simulationResults$hazardRatio, c(1.5984103, 1.9305192, 2.2892242, 2.6791588), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$hazardRatio, collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[1, ], c(7.2763799, 7.0838561, 6.7193502, 6.3616317), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[2, ], c(16.764021, 14.756285, 13.821816, 12.988284), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[3, ], c(38.977945, 24.200748, 26.934721, 11.875967), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[3, ], collapse = ", "), ")"))
	expect_equal(simulationResults$studyDuration, c(22.098154, 13.978342, 11.899449, 9.7796143), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[1, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResults$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[2, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResults$eventsNotAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[3, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResults$eventsNotAchieved[3, ], collapse = ", "), ")"))
	...
	expect_equal(simulationResults$overallReject, c(0.84, 0.92, 0.98, 0.99), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$overallReject, collapse = ", "), ")"))
	expect_gte(object = simulationResults$overallReject[1], expected = 0)
	expect_gte(object = simulationResults$overallReject[2], expected = 0)
	expect_gte(object = simulationResults$overallReject[3], expected = 0)
	expect_gte(object = simulationResults$overallReject[4], expected = 0)
	...
	expect_lte(object = simulationResults$overallReject[3], expected = 1)
	expect_lte(object = simulationResults$overallReject[4], expected = 1)
	expect_equal(simulationResults$rejectPerStage[1, ], c(0.18, 0.22, 0.39, 0.49), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$rejectPerStage[2, ], c(0.31, 0.59, 0.52, 0.48), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$rejectPerStage[3, ], c(0.35, 0.11, 0.07, 0.02), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[3, ], collapse = ", "), ")"))
	expect_equal(simulationResults$futilityStop, c(0.14, 0.07, 0.02, 0.01), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$futilityStop, collapse = ", "), ")"))
	expect_equal(simulationResults$futilityPerStage[1, ], c(0.13, 0.06, 0.02, 0.01), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$futilityPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$futilityPerStage[2, ], c(0.01, 0.01, 0, 0), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$futilityPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$earlyStop, c(0.63, 0.88, 0.93, 0.98), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfSubjects, c(429.00559, 423.54913, 384.3886, 348.2482), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfEvents, c(137.13, 85.39, 72.76, 57.98), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$expectedNumberOfEvents, collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_, NA_real_), label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[2, ], c(0.46273079, 0.58305775, 0.61313502, 0.59484117), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[3, ], c(0.66165116, 0.75066235, 0.71981679, 0.8), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[3, ], collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    invisible(capture.output(expect_error(print(simulationResults), NA)))
	    expect_output(print(simulationResults)$show())
	    invisible(capture.output(expect_error(summary(simulationResults), NA)))
...
test_that("'getSimulationSurvival': configuration 4", {
	...
	## Comparison of the results of SimulationResultsSurvival object 'simulationResults' with expected results
	expect_equal(simulationResults$accrualIntensity, c(23.809524, 47.619048, 47.619048), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$accrualIntensity, collapse = ", "), ")"))
	expect_equal(simulationResults$lambda1, c(0.0425, 0.068, 0.0255, 0.017, 0.0119), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$lambda1, collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[1, ], 6.3619038, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[2, ], 12.345684, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[3, ], 36.687962, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[3, ], collapse = ", "), ")"))
	expect_equal(simulationResults$studyDuration, 19.26207, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[1, ], 0, label = paste0("c(", paste0(simulationResults$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[2, ], 0, label = paste0("c(", paste0(simulationResults$eventsNotAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[3, ], 0, label = paste0("c(", paste0(simulationResults$eventsNotAchieved[3, ], collapse = ", "), ")"))
	...
	expect_equal(simulationResults$overallReject, 0.99, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$overallReject, collapse = ", "), ")"))
	expect_gte(object = simulationResults$overallReject[1], expected = 0)
	expect_lte(object = simulationResults$overallReject[1], expected = 1)
	expect_equal(simulationResults$rejectPerStage[1, ], 0.05, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$rejectPerStage[2, ], 0.65, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$rejectPerStage[3, ], 0.29, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[3, ], collapse = ", "), ")"))
	expect_equal(simulationResults$futilityStop, 0, label = paste0("c(", paste0(simulationResults$futilityStop, collapse = ", "), ")"))
	expect_equal(simulationResults$futilityPerStage[1, ], 0, label = paste0("c(", paste0(simulationResults$futilityPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$futilityPerStage[2, ], 0, label = paste0("c(", paste0(simulationResults$futilityPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$earlyStop, 0.7, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfSubjects, 450.42103, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfEvents, 121.64, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$expectedNumberOfEvents, collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[1, ], NA_real_, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[2, ], 0.49425129, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[3, ], 0.73157546, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[3, ], collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    invisible(capture.output(expect_error(print(simulationResults), NA)))
	    expect_output(print(simulationResults)$show())
	    invisible(capture.output(expect_error(summary(simulationResults), NA)))
...
test_that("'getSimulationSurvival': configuration 5", {
	...
	expect_equal(simulationResults$lambda2, 0.076357561, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$lambda2, collapse = ", "), ")"))
	expect_equal(simulationResults$hazardRatio, c(0.38925958, 0.47013781, 0.55749295, 0.6524534), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$hazardRatio, collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[1, ], c(8.1674426, 7.9228743, 7.6045868, 7.4881493), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[2, ], c(12.354338, 12.56529, 12.380125, 12.254955), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[3, ], c(16.473595, 17.9949, 17.847597, 17.390492), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[3, ], collapse = ", "), ")"))
	expect_equal(simulationResults$studyDuration, c(12.562909, 13.818364, 15.044701, 16.144285), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[1, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResults$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[2, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResults$eventsNotAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[3, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResults$eventsNotAchieved[3, ], collapse = ", "), ")"))
	...
	expect_equal(simulationResults$overallReject, c(0.99, 0.97, 0.68, 0.48), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$overallReject, collapse = ", "), ")"))
	expect_gte(object = simulationResults$overallReject[1], expected = 0)
	expect_gte(object = simulationResults$overallReject[2], expected = 0)
	expect_gte(object = simulationResults$overallReject[3], expected = 0)
	expect_gte(object = simulationResults$overallReject[4], expected = 0)
	...
	expect_lte(object = simulationResults$overallReject[3], expected = 1)
	expect_lte(object = simulationResults$overallReject[4], expected = 1)
	expect_equal(simulationResults$rejectPerStage[1, ], c(0.13, 0.11, 0.08, 0), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$rejectPerStage[2, ], c(0.69, 0.55, 0.34, 0.23), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$rejectPerStage[3, ], c(0.17, 0.31, 0.26, 0.25), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[3, ], collapse = ", "), ")"))
	expect_equal(simulationResults$futilityStop, c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResults$futilityStop, collapse = ", "), ")"))
	expect_equal(simulationResults$futilityPerStage[1, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResults$futilityPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$futilityPerStage[2, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResults$futilityPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$earlyStop, c(0.82, 0.66, 0.42, 0.23), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfSubjects, c(181.60287, 186.40002, 190.55503, 197.6859), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfEvents, c(49.58, 59.5, 73.87, 84.89), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$expectedNumberOfEvents, collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_, NA_real_), label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[2, ], c(0.56161185, 0.47418383, 0.31608317, 0.29578133), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[3, ], c(0.71394365, 0.57778506, 0.37448609, 0.32265113), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[3, ], collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    invisible(capture.output(expect_error(print(simulationResults), NA)))
	    expect_output(print(simulationResults)$show())
	    invisible(capture.output(expect_error(summary(simulationResults), NA)))
...
test_that("'getSimulationSurvival': configuration 6", {
	...
	## Comparison of the results of SimulationResultsSurvival object 'simulationResults' with expected results
	expect_equal(simulationResults$accrualIntensity, c(12.380952, 24.761905, 24.761905), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$accrualIntensity, collapse = ", "), ")"))
	expect_equal(simulationResults$lambda1, c(0.02, 0.032, 0.012, 0.008, 0.0056), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$lambda1, collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[1, ], 9.8001583, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[2, ], 134.1032, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[3, ], 189.74226, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[3, ], collapse = ", "), ")"))
	expect_equal(simulationResults$studyDuration, 39.514056, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[1, ], 0, label = paste0("c(", paste0(simulationResults$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[2, ], 0.62, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$eventsNotAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[3, ], 0.18, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$eventsNotAchieved[3, ], collapse = ", "), ")"))
	...
	expect_equal(simulationResults$overallReject, 0.1, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$overallReject, collapse = ", "), ")"))
	expect_gte(object = simulationResults$overallReject[1], expected = 0)
	expect_lte(object = simulationResults$overallReject[1], expected = 1)
	expect_equal(simulationResults$rejectPerStage[1, ], 0, label = paste0("c(", paste0(simulationResults$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$rejectPerStage[2, ], 0.07, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$rejectPerStage[3, ], 0.03, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[3, ], collapse = ", "), ")"))
	expect_equal(simulationResults$futilityStop, 0, label = paste0("c(", paste0(simulationResults$futilityStop, collapse = ", "), ")"))
	expect_equal(simulationResults$futilityPerStage[1, ], 0, label = paste0("c(", paste0(simulationResults$futilityPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$futilityPerStage[2, ], 0, label = paste0("c(", paste0(simulationResults$futilityPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$earlyStop, 0.07, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfSubjects, 258.7596, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfEvents, 215.70668, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$expectedNumberOfEvents, collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[1, ], NA_real_, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[2, ], 0.80033324, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[3, ], 0.64354689, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[3, ], collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    invisible(capture.output(expect_error(print(simulationResults), NA)))
	    expect_output(print(simulationResults)$show())
	    invisible(capture.output(expect_error(summary(simulationResults), NA)))
...
test_that("'getSimulationSurvival': configuration 7", {
	...
	## Comparison of the results of SimulationResultsSurvival object 'simulationResults' with expected results
	expect_equal(simulationResults$median1, 34.657359, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$median1, collapse = ", "), ")"))
	expect_equal(simulationResults$median2, 27.725887, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$median2, collapse = ", "), ")"))
	expect_equal(simulationResults$accrualIntensity, c(12.380952, 24.761905, 24.761905), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$accrualIntensity, collapse = ", "), ")"))
	expect_equal(simulationResults$lambda1, 0.02, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$lambda1, collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[1, ], 10.071413, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[2, ], 31.014645, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[3, ], 78.484045, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[3, ], collapse = ", "), ")"))
	expect_equal(simulationResults$studyDuration, 75.086051, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[1, ], 0, label = paste0("c(", paste0(simulationResults$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[2, ], 0, label = paste0("c(", paste0(simulationResults$eventsNotAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[3, ], 0, label = paste0("c(", paste0(simulationResults$eventsNotAchieved[3, ], collapse = ", "), ")"))
	...
	expect_equal(simulationResults$overallReject, 0.26, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$overallReject, collapse = ", "), ")"))
	expect_gte(object = simulationResults$overallReject[1], expected = 0)
	expect_lte(object = simulationResults$overallReject[1], expected = 1)
	expect_equal(simulationResults$rejectPerStage[1, ], 0, label = paste0("c(", paste0(simulationResults$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$rejectPerStage[2, ], 0.07, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$rejectPerStage[3, ], 0.19, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[3, ], collapse = ", "), ")"))
	expect_equal(simulationResults$futilityStop, 0, label = paste0("c(", paste0(simulationResults$futilityStop, collapse = ", "), ")"))
	expect_equal(simulationResults$futilityPerStage[1, ], 0, label = paste0("c(", paste0(simulationResults$futilityPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$futilityPerStage[2, ], 0, label = paste0("c(", paste0(simulationResults$futilityPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$earlyStop, 0.07, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfSubjects, 259.9986, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfEvents, 194.37, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$expectedNumberOfEvents, collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[1, ], NA_real_, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[2, ], 0.26815489, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[3, ], 0.24457773, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[3, ], collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    invisible(capture.output(expect_error(print(simulationResults), NA)))
	    expect_output(print(simulationResults)$show())
	    invisible(capture.output(expect_error(summary(simulationResults), NA)))
...
test_that("'getSimulationSurvival': configuration 8", {
	...
	## Comparison of the results of SimulationResultsSurvival object 'simulationResults' with expected results
	expect_equal(simulationResults$accrualIntensity, c(9.5238095, 19.047619, 19.047619), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$accrualIntensity, collapse = ", "), ")"))
	expect_equal(simulationResults$lambda1, c(0.008, 0.024), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$lambda1, collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[1, ], 14.155697, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[2, ], 19.508242, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[3, ], 25.008056, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[3, ], collapse = ", "), ")"))
	expect_equal(simulationResults$studyDuration, 24.627971, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[1, ], 0, label = paste0("c(", paste0(simulationResults$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[2, ], 0, label = paste0("c(", paste0(simulationResults$eventsNotAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[3, ], 0, label = paste0("c(", paste0(simulationResults$eventsNotAchieved[3, ], collapse = ", "), ")"))
	...
	expect_equal(simulationResults$overallReject, 0.11, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$overallReject, collapse = ", "), ")"))
	expect_gte(object = simulationResults$overallReject[1], expected = 0)
	expect_lte(object = simulationResults$overallReject[1], expected = 1)
	expect_equal(simulationResults$rejectPerStage[1, ], 0.01, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$rejectPerStage[2, ], 0.04, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$rejectPerStage[3, ], 0.06, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[3, ], collapse = ", "), ")"))
	expect_equal(simulationResults$futilityStop, 0, label = paste0("c(", paste0(simulationResults$futilityStop, collapse = ", "), ")"))
	expect_equal(simulationResults$futilityPerStage[1, ], 0, label = paste0("c(", paste0(simulationResults$futilityPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$futilityPerStage[2, ], 0, label = paste0("c(", paste0(simulationResults$futilityPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$earlyStop, 0.05, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfSubjects, 199.9973, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfEvents, 58.8, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$expectedNumberOfEvents, collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[1, ], NA_real_, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[2, ], 0.13387917, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[3, ], 0.12806393, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[3, ], collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    invisible(capture.output(expect_error(print(simulationResults), NA)))
	    expect_output(print(simulationResults)$show())
	    invisible(capture.output(expect_error(summary(simulationResults), NA)))
...
test_that("'getSimulationSurvival': configuration 9;", {
	...
	## Comparison of the results of SimulationResultsSurvival object 'simulationResults' with expected results
	expect_equal(simulationResults$accrualIntensity, c(12.380952, 24.761905, 24.761905), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$accrualIntensity, collapse = ", "), ")"))
	expect_equal(simulationResults$lambda1, c(0.0075, 0.0225), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$lambda1, collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[1, ], 12.905156, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[2, ], 31.363371, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[3, ], 71.176717, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[3, ], collapse = ", "), ")"))
	expect_equal(simulationResults$studyDuration, 65.836001, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[1, ], 0, label = paste0("c(", paste0(simulationResults$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[2, ], 0, label = paste0("c(", paste0(simulationResults$eventsNotAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[3, ], 0, label = paste0("c(", paste0(simulationResults$eventsNotAchieved[3, ], collapse = ", "), ")"))
	...
	expect_equal(simulationResults$overallReject, 0.47, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$overallReject, collapse = ", "), ")"))
	expect_gte(object = simulationResults$overallReject[1], expected = 0)
	expect_lte(object = simulationResults$overallReject[1], expected = 1)
	expect_equal(simulationResults$rejectPerStage[1, ], 0.01, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$rejectPerStage[2, ], 0.12, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$rejectPerStage[3, ], 0.34, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[3, ], collapse = ", "), ")"))
	expect_equal(simulationResults$futilityStop, 0, label = paste0("c(", paste0(simulationResults$futilityStop, collapse = ", "), ")"))
	expect_equal(simulationResults$futilityPerStage[1, ], 0, label = paste0("c(", paste0(simulationResults$futilityPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$futilityPerStage[2, ], 0, label = paste0("c(", paste0(simulationResults$futilityPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$earlyStop, 0.13, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfSubjects, 259.9727, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfEvents, 183.23, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$expectedNumberOfEvents, collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[1, ], NA_real_, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[2, ], 0.28641702, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[3, ], 0.33103011, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[3, ], collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    invisible(capture.output(expect_error(print(simulationResults), NA)))
	    expect_output(print(simulationResults)$show())
	    invisible(capture.output(expect_error(summary(simulationResults), NA)))
...
test_that("'getSimulationSurvival': configuration 10;", {
	...
	## Comparison of the results of SimulationResultsSurvival object 'simulationResults' with expected results
	expect_equal(simulationResults$pi1, c(0.23662051, 0.25023841, 0.27674976), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$pi1, collapse = ", "), ")"))
	expect_equal(simulationResults$pi2, 0.30232367, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$pi2, collapse = ", "), ")"))
	expect_equal(simulationResults$median1, c(30.806541, 28.881133, 25.672118), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$median1, collapse = ", "), ")"))
	expect_equal(simulationResults$median2, 23.104906, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$median2, collapse = ", "), ")"))
	expect_equal(simulationResults$accrualIntensity, c(12.380952, 24.761905, 24.761905), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$accrualIntensity, collapse = ", "), ")"))
	expect_equal(simulationResults$lambda1, c(0.0225, 0.024, 0.027), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$lambda1, collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[1, ], c(9.4112305, 9.2753297, 9.1968922), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[2, ], c(27.054738, 27.519552, 26.652741), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[3, ], c(67.286427, 67.154864, 68.163763), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[3, ], collapse = ", "), ")"))
	expect_equal(simulationResults$studyDuration, c(61.651041, 62.169663, 64.720225), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[1, ], c(0, 0, 0), label = paste0("c(", paste0(simulationResults$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[2, ], c(0, 0, 0), label = paste0("c(", paste0(simulationResults$eventsNotAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[3, ], c(0, 0, 0), label = paste0("c(", paste0(simulationResults$eventsNotAchieved[3, ], collapse = ", "), ")"))
	...
	expect_equal(simulationResults$overallReject, c(0.46, 0.36, 0.13), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$overallReject, collapse = ", "), ")"))
	expect_gte(object = simulationResults$overallReject[1], expected = 0)
	expect_gte(object = simulationResults$overallReject[2], expected = 0)
	expect_gte(object = simulationResults$overallReject[3], expected = 0)
	expect_lte(object = simulationResults$overallReject[1], expected = 1)
	expect_lte(object = simulationResults$overallReject[2], expected = 1)
	expect_lte(object = simulationResults$overallReject[3], expected = 1)
	expect_equal(simulationResults$rejectPerStage[1, ], c(0, 0.01, 0.01), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$rejectPerStage[2, ], c(0.14, 0.11, 0.06), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$rejectPerStage[3, ], c(0.32, 0.24, 0.06), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[3, ], collapse = ", "), ")"))
	expect_equal(simulationResults$futilityStop, c(0, 0, 0), label = paste0("c(", paste0(simulationResults$futilityStop, collapse = ", "), ")"))
	expect_equal(simulationResults$futilityPerStage[1, ], c(0, 0, 0), label = paste0("c(", paste0(simulationResults$futilityPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$futilityPerStage[2, ], c(0, 0, 0), label = paste0("c(", paste0(simulationResults$futilityPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$earlyStop, c(0.14, 0.12, 0.07), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfSubjects, c(259.8404, 259.29746, 259.28089), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfEvents, c(184.28, 187.82, 203.16), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$expectedNumberOfEvents, collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_), label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[2, ], c(0.30728214, 0.23928832, 0.1863817), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[3, ], c(0.33344952, 0.28614054, 0.14302818), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[3, ], collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    invisible(capture.output(expect_error(print(simulationResults), NA)))
	    expect_output(print(simulationResults)$show())
	    invisible(capture.output(expect_error(summary(simulationResults), NA)))
...
test_that("'getSimulationSurvival': configuration 11;", {
	...
	myCalcEventsFunction <- function(...,
		...
		if (stage == 2){
			...
			requiredStageEvents <- min(
				...
				maxNumberOfEventsPerStage[stage]) + eventsOverStages[stage - 1]
		} else {
	...
	## Comparison of the results of SimulationResultsSurvival object 'simulationResults' with expected results
	expect_equal(simulationResults$pi1, c(0.3, 0.41433798, 0.51, 0.59003659), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$pi1, collapse = ", "), ")"))
	expect_equal(simulationResults$median1, c(23.320299, 15.546866, 11.660149, 9.3281194), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$median1, collapse = ", "), ")"))
	expect_equal(simulationResults$median2, 23.320299, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$median2, collapse = ", "), ")"))
	expect_equal(simulationResults$accrualIntensity, 66.666667, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$accrualIntensity, collapse = ", "), ")"))
	expect_equal(simulationResults$lambda1, c(0.029722912, 0.044584368, 0.059445824, 0.07430728), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$lambda1, collapse = ", "), ")"))
	expect_equal(simulationResults$lambda2, 0.029722912, tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$lambda2, collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[1, ], c(7.9897023, 7.1475519, 6.494373, 6.2294549), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[2, ], c(17.213741, 10.852607, 9.0020285, 8.4492782), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$analysisTime[3, ], c(28.255907, 20.342199, NA_real_, NA_real_), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$analysisTime[3, ], collapse = ", "), ")"))
	expect_equal(simulationResults$studyDuration, c(28.255907, 12.725375, 7.9469034, 7.3207992), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[1, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResults$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[2, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResults$eventsNotAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$eventsNotAchieved[3, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResults$eventsNotAchieved[3, ], collapse = ", "), ")"))
	...
	expect_equal(simulationResults$overallReject, c(0.1, 1, 1, 1), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$overallReject, collapse = ", "), ")"))
	expect_gte(object = simulationResults$overallReject[1], expected = 0)
	expect_gte(object = simulationResults$overallReject[2], expected = 0)
	expect_gte(object = simulationResults$overallReject[3], expected = 0)
	expect_gte(object = simulationResults$overallReject[4], expected = 0)
	...
	expect_lte(object = simulationResults$overallReject[3], expected = 1)
	expect_lte(object = simulationResults$overallReject[4], expected = 1)
	expect_equal(simulationResults$rejectPerStage[1, ], c(0, 0.1, 0.4, 0.5), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$rejectPerStage[2, ], c(0, 0.6, 0.6, 0.5), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$rejectPerStage[3, ], c(0.1, 0.3, 0, 0), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$rejectPerStage[3, ], collapse = ", "), ")"))
	expect_equal(simulationResults$futilityStop, c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResults$futilityStop, collapse = ", "), ")"))
	expect_equal(simulationResults$futilityPerStage[1, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResults$futilityPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$futilityPerStage[2, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResults$futilityPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$earlyStop, c(0, 0.7, 1, 1), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfSubjects, c(800, 690.01, 532.76, 488.85), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResults$expectedNumberOfEvents, c(383.6, 165, 85.6, 80), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$expectedNumberOfEvents, collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_, NA_real_), label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[2, ], c(0.044313374, 0.60865148, 0.72866566, 0.82381582), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResults$conditionalPowerAchieved[3, ], c(0.013892246, 0.84869906, NA_real_, NA_real_), tolerance = 1e-07, label = paste0("c(", paste0(simulationResults$conditionalPowerAchieved[3, ], collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    invisible(capture.output(expect_error(print(simulationResults), NA)))
	    expect_output(print(simulationResults)$show())
	    invisible(capture.output(expect_error(summary(simulationResults), NA)))
...
test_that("'getSimulationSurvival': Fixed sample size with minimum required definitions, pi1 = c(0.4, 0.5, 0.6) and pi2 = 0.2 at event time 12, accrual time 12 and follow-up time 6 as default", {
	...
	expect_equal(simulationResult$median1, c(37.275405, 23.320299, 16.282985, 12), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$median1, collapse = ", "), ")"))
	expect_equal(simulationResult$median2, 37.275405, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$median2, collapse = ", "), ")"))
	expect_equal(simulationResult$accrualIntensity, 16.666667, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$accrualIntensity, collapse = ", "), ")"))
	expect_equal(simulationResult$lambda1, c(0.018595296, 0.029722912, 0.042568802, 0.057762265), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$lambda1, collapse = ", "), ")"))
	expect_equal(simulationResult$lambda2, 0.018595296, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$lambda2, collapse = ", "), ")"))
	expect_equal(simulationResult$hazardRatio, c(1, 1.5984103, 2.2892242, 3.1062837), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$hazardRatio, collapse = ", "), ")"))
	expect_equal(simulationResult$analysisTime[1, ], c(17.941133, 15.499503, 13.535749, 12.34), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$studyDuration, c(17.941133, 15.499503, 13.535749, 12.34), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResult$eventsNotAchieved[1, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResult$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$iterations[1, ], c(100, 100, 100, 100), label = paste0("c(", paste0(simulationResult$iterations[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$overallReject, c(0.01, 0.3, 0.68, 0.95), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$overallReject, collapse = ", "), ")"))
	expect_equal(simulationResult$rejectPerStage[1, ], c(0.01, 0.3, 0.68, 0.95), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$earlyStop, c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResult$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResult$expectedNumberOfSubjects, c(200, 200, 199.71, 196.74), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResult$expectedNumberOfEvents, c(40, 40, 40, 40), label = paste0("c(", paste0(simulationResult$expectedNumberOfEvents, collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
...
test_that("'getSimulationSurvival': Determine necessary accrual time if 200 subjects and 30 subjects per time unit can be recruited", {
	...
	expect_equal(simulationResult$lambda2, 0.018595296, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$lambda2, collapse = ", "), ")"))
	expect_equal(simulationResult$hazardRatio, c(1, 1.5984103, 2.2892242, 3.1062837), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$hazardRatio, collapse = ", "), ")"))
	expect_equal(simulationResult$analysisTime[1, ], c(15.255121, 12.685136, 10.656532, 9.4294312), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$studyDuration, c(15.255121, 12.685136, 10.656532, 9.4294312), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResult$eventsNotAchieved[1, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResult$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$iterations[1, ], c(100, 100, 100, 100), label = paste0("c(", paste0(simulationResult$iterations[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$overallReject, c(0.02, 0.28, 0.77, 0.96), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$overallReject, collapse = ", "), ")"))
	expect_equal(simulationResult$rejectPerStage[1, ], c(0.02, 0.28, 0.77, 0.96), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$earlyStop, c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResult$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResult$expectedNumberOfSubjects, c(200, 200, 200, 200), label = paste0("c(", paste0(simulationResult$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResult$expectedNumberOfEvents, c(40, 40, 40, 40), label = paste0("c(", paste0(simulationResult$expectedNumberOfEvents, collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    invisible(capture.output(expect_error(print(simulationResult), NA)))
	    expect_output(print(simulationResult)$show())
...
test_that("'getSimulationSurvival': Determine necessary accrual time if 200 subjects and if the first 6 time units 20 subjects per time unit can be recruited, then 30 subjects per time unit", {
	...
	expect_equal(simulationResult$lambda2, 0.018595296, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$lambda2, collapse = ", "), ")"))
	expect_equal(simulationResult$hazardRatio, c(1, 1.5984103, 2.2892242, 3.1062837), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$hazardRatio, collapse = ", "), ")"))
	expect_equal(simulationResult$analysisTime[1, ], c(16.683961, 14.141068, 12.109744, 10.96314), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$studyDuration, c(16.683961, 14.141068, 12.109744, 10.96314), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResult$eventsNotAchieved[1, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResult$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$iterations[1, ], c(100, 100, 100, 100), label = paste0("c(", paste0(simulationResult$iterations[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$overallReject, c(0.01, 0.28, 0.72, 0.96), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$overallReject, collapse = ", "), ")"))
	expect_equal(simulationResult$rejectPerStage[1, ], c(0.01, 0.28, 0.72, 0.96), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$earlyStop, c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResult$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResult$expectedNumberOfSubjects, c(200, 200, 200, 200), label = paste0("c(", paste0(simulationResult$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResult$expectedNumberOfEvents, c(40, 40, 40, 40), label = paste0("c(", paste0(simulationResult$expectedNumberOfEvents, collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
...
test_that("'getSimulationSurvival': Determine maximum number of Subjects if the first 6 time units 20 subjects per time unit can be recruited, and after 10 time units 30 subjects per time unit", {
	...
	expect_equal(simulationResult$median1, c(37.275405, 23.320299, 16.282985, 12), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$median1, collapse = ", "), ")"))
	expect_equal(simulationResult$median2, 37.275405, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$median2, collapse = ", "), ")"))
	expect_equal(simulationResult$maxNumberOfSubjects, 240, label = paste0("c(", paste0(simulationResult$maxNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResult$lambda1, c(0.018595296, 0.029722912, 0.042568802, 0.057762265), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$lambda1, collapse = ", "), ")"))
	expect_equal(simulationResult$lambda2, 0.018595296, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$lambda2, collapse = ", "), ")"))
	expect_equal(simulationResult$hazardRatio, c(1, 1.5984103, 2.2892242, 3.1062837), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$hazardRatio, collapse = ", "), ")"))
	expect_equal(simulationResult$analysisTime[1, ], c(15.210978, 13.172199, 11.59631, 10.698373), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$studyDuration, c(15.210978, 13.172199, 11.59631, 10.698373), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResult$eventsNotAchieved[1, ], c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResult$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$iterations[1, ], c(100, 100, 100, 100), label = paste0("c(", paste0(simulationResult$iterations[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$overallReject, c(0.04, 0.33, 0.75, 0.95), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$overallReject, collapse = ", "), ")"))
	expect_equal(simulationResult$rejectPerStage[1, ], c(0.04, 0.33, 0.75, 0.95), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$earlyStop, c(0, 0, 0, 0), label = paste0("c(", paste0(simulationResult$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResult$expectedNumberOfSubjects, c(240, 240, 239.63, 237.56), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResult$expectedNumberOfEvents, c(40, 40, 40, 40), label = paste0("c(", paste0(simulationResult$expectedNumberOfEvents, collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    invisible(capture.output(expect_error(print(simulationResult), NA)))
	    expect_output(print(simulationResult)$show())
...
test_that("'getSimulationSurvival': Specify effect size for a two-stage group design with O'Brien & Fleming boundaries Effect size is based on event rates at specified event time, directionUpper = FALSE needs to be specified because it should be shown that hazard ratio < 1", {
	...
	## Comparison of the results of SimulationResultsSurvival object 'simulationResult' with expected results
	expect_equal(simulationResult$median1, 74.550809, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$median1, collapse = ", "), ")"))
	expect_equal(simulationResult$median2, 46.640597, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$median2, collapse = ", "), ")"))
	expect_equal(simulationResult$accrualIntensity, 16.666667, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$accrualIntensity, collapse = ", "), ")"))
	expect_equal(simulationResult$lambda1, 0.009297648, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$lambda1, collapse = ", "), ")"))
	expect_equal(simulationResult$lambda2, 0.014861456, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$lambda2, collapse = ", "), ")"))
	expect_equal(simulationResult$hazardRatio, 0.62562161, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$hazardRatio, collapse = ", "), ")"))
	expect_equal(simulationResult$analysisTime[1, ], 14.769473, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$analysisTime[2, ], 24.499634, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$analysisTime[2, ], collapse = ", "), ")"))
	expect_equal(simulationResult$studyDuration, 24.198958, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResult$eventsNotAchieved[1, ], 0, label = paste0("c(", paste0(simulationResult$eventsNotAchieved[1, ], collapse = ", "), ")"))
	...
	expect_equal(simulationResult$rejectPerStage[1, ], 0.03, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$rejectPerStage[2, ], 0.24, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$rejectPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResult$futilityPerStage[1, ], 0, label = paste0("c(", paste0(simulationResult$futilityPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$earlyStop, 0.03, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResult$expectedNumberOfSubjects, 199.9841, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResult$expectedNumberOfEvents, 39.4, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$expectedNumberOfEvents, collapse = ", "), ")"))
	expect_equal(simulationResult$conditionalPowerAchieved[1, ], NA_real_, label = paste0("c(", paste0(simulationResult$conditionalPowerAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$conditionalPowerAchieved[2, ], 0.29516222, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$conditionalPowerAchieved[2, ], collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    invisible(capture.output(expect_error(print(simulationResult), NA)))
	    expect_output(print(simulationResult)$show())
	    invisible(capture.output(expect_error(summary(simulationResult), NA)))
...
test_that("'getSimulationSurvival': As above, but with a three-stage O'Brien and Fleming design with specified information rates, note that planned events consists of integer values", {
	...
	expect_equal(simulationResult$lambda2, 0.014861456, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$lambda2, collapse = ", "), ")"))
	expect_equal(simulationResult$hazardRatio, 0.62562161, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$hazardRatio, collapse = ", "), ")"))
	expect_equal(simulationResult$analysisTime[1, ], 13.073331, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$analysisTime[2, ], 18.748105, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$analysisTime[2, ], collapse = ", "), ")"))
	expect_equal(simulationResult$analysisTime[3, ], 24.810251, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$analysisTime[3, ], collapse = ", "), ")"))
	expect_equal(simulationResult$studyDuration, 23.877826, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResult$eventsNotAchieved[1, ], 0, label = paste0("c(", paste0(simulationResult$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$eventsNotAchieved[2, ], 0, label = paste0("c(", paste0(simulationResult$eventsNotAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResult$eventsNotAchieved[3, ], 0, label = paste0("c(", paste0(simulationResult$eventsNotAchieved[3, ], collapse = ", "), ")"))
	...
	expect_equal(simulationResult$overallReject, 0.322, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$overallReject, collapse = ", "), ")"))
	expect_equal(simulationResult$rejectPerStage[1, ], 0.015, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$rejectPerStage[2, ], 0.124, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$rejectPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResult$rejectPerStage[3, ], 0.183, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$rejectPerStage[3, ], collapse = ", "), ")"))
	expect_equal(simulationResult$futilityStop, 0, label = paste0("c(", paste0(simulationResult$futilityStop, collapse = ", "), ")"))
	expect_equal(simulationResult$futilityPerStage[1, ], 0, label = paste0("c(", paste0(simulationResult$futilityPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$futilityPerStage[2, ], 0, label = paste0("c(", paste0(simulationResult$futilityPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResult$earlyStop, 0.139, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResult$expectedNumberOfSubjects, 199.92969, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResult$expectedNumberOfEvents, 38.152, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$expectedNumberOfEvents, collapse = ", "), ")"))
	expect_equal(simulationResult$conditionalPowerAchieved[1, ], NA_real_, label = paste0("c(", paste0(simulationResult$conditionalPowerAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$conditionalPowerAchieved[2, ], 0.19637573, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$conditionalPowerAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simulationResult$conditionalPowerAchieved[3, ], 0.23542216, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$conditionalPowerAchieved[3, ], collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    invisible(capture.output(expect_error(print(simulationResult), NA)))
	    expect_output(print(simulationResult)$show())
	    invisible(capture.output(expect_error(summary(simulationResult), NA)))
...
test_that("'getSimulationSurvival': Effect size is based on event rate at specified event time for the reference group and hazard ratio, directionUpper = FALSE needs to be specified because it should be shown that hazard ratio < 1", {
	...
	## Comparison of the results of SimulationResultsSurvival object 'simulationResult' with expected results
	expect_equal(simulationResult$pi1, 0.16333997, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$pi1, collapse = ", "), ")"))
	expect_equal(simulationResult$median1, 93.281194, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$median1, collapse = ", "), ")"))
	expect_equal(simulationResult$median2, 46.640597, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$median2, collapse = ", "), ")"))
	expect_equal(simulationResult$accrualIntensity, 16.666667, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$accrualIntensity, collapse = ", "), ")"))
	expect_equal(simulationResult$lambda1, 0.007430728, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$lambda1, collapse = ", "), ")"))
	expect_equal(simulationResult$lambda2, 0.014861456, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$lambda2, collapse = ", "), ")"))
	expect_equal(simulationResult$analysisTime[1, ], 15.596955, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$analysisTime[2, ], 26.310745, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$analysisTime[2, ], collapse = ", "), ")"))
	expect_equal(simulationResult$studyDuration, 25.440402, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResult$eventsNotAchieved[1, ], 0, label = paste0("c(", paste0(simulationResult$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$eventsNotAchieved[2, ], 0, label = paste0("c(", paste0(simulationResult$eventsNotAchieved[2, ], collapse = ", "), ")"))
	...
	expect_equal(simulationResult$rejectPerStage[1, ], 0.08, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$rejectPerStage[2, ], 0.44, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$rejectPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResult$futilityPerStage[1, ], 0, label = paste0("c(", paste0(simulationResult$futilityPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$earlyStop, 0.08, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResult$expectedNumberOfSubjects, 199.9752, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResult$expectedNumberOfEvents, 38.4, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$expectedNumberOfEvents, collapse = ", "), ")"))
	expect_equal(simulationResult$conditionalPowerAchieved[1, ], NA_real_, label = paste0("c(", paste0(simulationResult$conditionalPowerAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$conditionalPowerAchieved[2, ], 0.43087375, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$conditionalPowerAchieved[2, ], collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    invisible(capture.output(expect_error(print(simulationResult), NA)))
	    expect_output(print(simulationResult)$show())
	    invisible(capture.output(expect_error(summary(simulationResult), NA)))
...
test_that("'getSimulationSurvival': Effect size is based on hazard rate for the reference group and hazard ratio, directionUpper = FALSE needs to be specified because it should be shown that hazard ratio < 1", {
	...
	## Comparison of the results of SimulationResultsSurvival object 'simulationResult' with expected results
	expect_equal(simulationResult$median1, 69.314718, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$median1, collapse = ", "), ")"))
	expect_equal(simulationResult$median2, 34.657359, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$median2, collapse = ", "), ")"))
	expect_equal(simulationResult$accrualIntensity, 16.666667, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$accrualIntensity, collapse = ", "), ")"))
	expect_equal(simulationResult$lambda1, 0.01, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$lambda1, collapse = ", "), ")"))
	expect_equal(simulationResult$analysisTime[1, ], 13.132525, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$analysisTime[2, ], 21.186744, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$analysisTime[2, ], collapse = ", "), ")"))
	expect_equal(simulationResult$studyDuration, 20.690944, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResult$eventsNotAchieved[1, ], 0, label = paste0("c(", paste0(simulationResult$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$eventsNotAchieved[2, ], 0, label = paste0("c(", paste0(simulationResult$eventsNotAchieved[2, ], collapse = ", "), ")"))
	...
	expect_equal(simulationResult$rejectPerStage[1, ], 0.06, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$rejectPerStage[2, ], 0.43, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$rejectPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResult$futilityPerStage[1, ], 0, label = paste0("c(", paste0(simulationResult$futilityPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$earlyStop, 0.06, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResult$expectedNumberOfSubjects, 199.73, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResult$expectedNumberOfEvents, 38.8, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$expectedNumberOfEvents, collapse = ", "), ")"))
	expect_equal(simulationResult$conditionalPowerAchieved[1, ], NA_real_, label = paste0("c(", paste0(simulationResult$conditionalPowerAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$conditionalPowerAchieved[2, ], 0.48014443, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$conditionalPowerAchieved[2, ], collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    invisible(capture.output(expect_error(print(simulationResult), NA)))
	    expect_output(print(simulationResult)$show())
	    invisible(capture.output(expect_error(summary(simulationResult), NA)))
...
test_that("'getSimulationSurvival': Specification of piecewise exponential survival time and hazard ratios, note that in getSimulationSurvival only one hazard ratio is used in the case that the survival time is piecewise exponential", {
	...
	## Comparison of the results of SimulationResultsSurvival object 'simulationResult' with expected results
	expect_equal(simulationResult$accrualIntensity, 16.666667, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$accrualIntensity, collapse = ", "), ")"))
	expect_equal(simulationResult$lambda1, c(0.015, 0.03, 0.06), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$lambda1, collapse = ", "), ")"))
	expect_equal(simulationResult$analysisTime[1, ], 12.106711, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$analysisTime[2, ], 16.150578, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$analysisTime[2, ], collapse = ", "), ")"))
	expect_equal(simulationResult$studyDuration, 16.020702, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResult$eventsNotAchieved[1, ], 0, label = paste0("c(", paste0(simulationResult$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$eventsNotAchieved[2, ], 0, label = paste0("c(", paste0(simulationResult$eventsNotAchieved[2, ], collapse = ", "), ")"))
	...
	expect_equal(simulationResult$rejectPerStage[1, ], 0.04, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$rejectPerStage[2, ], 0.28, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$rejectPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResult$futilityPerStage[1, ], 0, label = paste0("c(", paste0(simulationResult$futilityPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$earlyStop, 0.04, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResult$expectedNumberOfSubjects, 199.7404, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResult$expectedNumberOfEvents, 39.2, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$expectedNumberOfEvents, collapse = ", "), ")"))
	expect_equal(simulationResult$conditionalPowerAchieved[1, ], NA_real_, label = paste0("c(", paste0(simulationResult$conditionalPowerAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$conditionalPowerAchieved[2, ], 0.33404702, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$conditionalPowerAchieved[2, ], collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    invisible(capture.output(expect_error(print(simulationResult), NA)))
	    expect_output(print(simulationResult)$show())
	    invisible(capture.output(expect_error(summary(simulationResult), NA)))
...
test_that("'getSimulationSurvival': Specification of piecewise exponential survival time for both treatment arms", {
	...
	## Comparison of the results of SimulationResultsSurvival object 'simulationResult' with expected results
	expect_equal(simulationResult$accrualIntensity, 16.666667, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$accrualIntensity, collapse = ", "), ")"))
	expect_equal(simulationResult$hazardRatio, 1.5, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$hazardRatio, collapse = ", "), ")"))
	expect_equal(simulationResult$analysisTime[1, ], 12.106711, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$analysisTime[2, ], 16.150578, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$analysisTime[2, ], collapse = ", "), ")"))
	expect_equal(simulationResult$studyDuration, 16.020702, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResult$eventsNotAchieved[1, ], 0, label = paste0("c(", paste0(simulationResult$eventsNotAchieved[1, ], collapse = ", "), ")"))
	...
	## Comparison of the results of SimulationResultsSurvival object 'simulationResult' with expected results
	expect_equal(simulationResult$accrualIntensity, 16.666667, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$accrualIntensity, collapse = ", "), ")"))
	expect_equal(simulationResult$hazardRatio, c(1, 1, 1.5), tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$hazardRatio, collapse = ", "), ")"))
	expect_equal(simulationResult$analysisTime[1, ], 12.973056, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$analysisTime[2, ], 17.030809, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$analysisTime[2, ], collapse = ", "), ")"))
	expect_equal(simulationResult$studyDuration, 17.030809, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$studyDuration, collapse = ", "), ")"))
	expect_equal(simulationResult$eventsNotAchieved[1, ], 0, label = paste0("c(", paste0(simulationResult$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$eventsNotAchieved[2, ], 0, label = paste0("c(", paste0(simulationResult$eventsNotAchieved[2, ], collapse = ", "), ")"))
	...
	expect_equal(simulationResult$rejectPerStage[1, ], 0, label = paste0("c(", paste0(simulationResult$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$rejectPerStage[2, ], 0.06, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$rejectPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simulationResult$futilityPerStage[1, ], 0, label = paste0("c(", paste0(simulationResult$futilityPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$earlyStop, 0, label = paste0("c(", paste0(simulationResult$earlyStop, collapse = ", "), ")"))
	expect_equal(simulationResult$expectedNumberOfSubjects, 200, label = paste0("c(", paste0(simulationResult$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simulationResult$expectedNumberOfEvents, 40, label = paste0("c(", paste0(simulationResult$expectedNumberOfEvents, collapse = ", "), ")"))
	expect_equal(simulationResult$conditionalPowerAchieved[1, ], NA_real_, label = paste0("c(", paste0(simulationResult$conditionalPowerAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simulationResult$conditionalPowerAchieved[2, ], 0.1789388, tolerance = 1e-07, label = paste0("c(", paste0(simulationResult$conditionalPowerAchieved[2, ], collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	    invisible(capture.output(expect_error(print(simulationResult), NA)))
	    expect_output(print(simulationResult)$show())
	    invisible(capture.output(expect_error(summary(simulationResult), NA)))
...
test_that("'getSimulationSurvival': Perform recalculation of number of events based on conditional power", {
	...
	expect_equal(resultsWithSSR1$pi1, c(0.3, 0.32452723, 0.34819506, 0.37103359, 0.39307188, 0.41433798, 0.43485894), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR1$pi1, collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$median1, c(23.320299, 21.200271, 19.433582, 17.938691, 16.657356, 15.546866, 14.575187), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR1$median1, collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$median2, 23.320299, tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR1$median2, collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$accrualIntensity, 66.666667, tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR1$accrualIntensity, collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$lambda1, c(0.029722912, 0.032695203, 0.035667494, 0.038639786, 0.041612077, 0.044584368, 0.047556659), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR1$lambda1, collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$lambda2, 0.029722912, tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR1$lambda2, collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$analysisTime[1, ], c(7.9761501, 7.8239889, 7.5191849, 7.4832292, 7.3291066, 7.1091953, 6.9737455), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR1$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$analysisTime[2, ], c(17.76189, 17.229038, 16.567328, 16.175906, 15.668575, 15.328143, 14.604753), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR1$analysisTime[2, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$analysisTime[3, ], c(30.192276, 28.615009, 26.463502, 25.657109, 23.821118, 23.34898, 22.534023), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR1$analysisTime[3, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$studyDuration, c(29.683899, 28.160756, 25.20615, 22.190278, 19.319577, 18.030286, 14.789904), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR1$studyDuration, collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$eventsNotAchieved[1, ], c(0, 0, 0, 0, 0, 0, 0), label = paste0("c(", paste0(resultsWithSSR1$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$eventsNotAchieved[2, ], c(0, 0, 0, 0, 0, 0, 0), label = paste0("c(", paste0(resultsWithSSR1$eventsNotAchieved[2, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$eventsNotAchieved[3, ], c(0, 0, 0, 0, 0, 0, 0), label = paste0("c(", paste0(resultsWithSSR1$eventsNotAchieved[3, ], collapse = ", "), ")"))
	...
	expect_equal(resultsWithSSR1$overallReject, c(0.04, 0.16, 0.38, 0.75, 0.91, 0.95, 1), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR1$overallReject, collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$rejectPerStage[1, ], c(0, 0, 0, 0.02, 0.04, 0.01, 0.08), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR1$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$rejectPerStage[2, ], c(0.04, 0.04, 0.12, 0.31, 0.46, 0.64, 0.81), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR1$rejectPerStage[2, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$rejectPerStage[3, ], c(0, 0.12, 0.26, 0.42, 0.41, 0.3, 0.11), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR1$rejectPerStage[3, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$futilityStop, c(0, 0, 0, 0, 0, 0, 0), label = paste0("c(", paste0(resultsWithSSR1$futilityStop, collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$futilityPerStage[1, ], c(0, 0, 0, 0, 0, 0, 0), label = paste0("c(", paste0(resultsWithSSR1$futilityPerStage[1, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$futilityPerStage[2, ], c(0, 0, 0, 0, 0, 0, 0), label = paste0("c(", paste0(resultsWithSSR1$futilityPerStage[2, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$earlyStop, c(0.04, 0.04, 0.12, 0.33, 0.5, 0.65, 0.89), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR1$earlyStop, collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$expectedNumberOfSubjects, c(800, 800, 799.934, 793.55401, 785.93916, 794.85349, 767.86699), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR1$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$expectedNumberOfEvents, c(401.92, 394, 365.45, 325.77, 290.4, 275.74, 221.24), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR1$expectedNumberOfEvents, collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_, NA_real_, NA_real_, NA_real_, NA_real_), label = paste0("c(", paste0(resultsWithSSR1$conditionalPowerAchieved[1, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$conditionalPowerAchieved[2, ], c(0.12165751, 0.15502837, 0.23497758, 0.29890789, 0.33886493, 0.41286728, 0.49916888), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR1$conditionalPowerAchieved[2, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR1$conditionalPowerAchieved[3, ], c(0.14749827, 0.23857933, 0.44868993, 0.59763371, 0.65378645, 0.66059558, 0.69812096), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR1$conditionalPowerAchieved[3, ], collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	...
	expect_equal(resultsWithSSR2$pi1, c(0.3, 0.32452723, 0.34819506, 0.37103359, 0.39307188, 0.41433798, 0.43485894), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR2$pi1, collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$median1, c(23.320299, 21.200271, 19.433582, 17.938691, 16.657356, 15.546866, 14.575187), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR2$median1, collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$median2, 23.320299, tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR2$median2, collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$accrualIntensity, 66.666667, tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR2$accrualIntensity, collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$lambda1, c(0.029722912, 0.032695203, 0.035667494, 0.038639786, 0.041612077, 0.044584368, 0.047556659), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR2$lambda1, collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$lambda2, 0.029722912, tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR2$lambda2, collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$analysisTime[1, ], c(7.9761501, 7.8239889, 7.5191849, 7.4832292, 7.3291066, 7.1091953, 6.9737455), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR2$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$analysisTime[2, ], c(17.532866, 16.792737, 15.753436, 15.242772, 14.414526, 13.395253, 12.536642), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR2$analysisTime[2, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$analysisTime[3, ], c(29.782185, 28.27297, 25.249508, 24.235039, 21.407797, 20.846814, 17.625231), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR2$analysisTime[3, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$studyDuration, c(29.663096, 27.530562, 24.305604, 21.136576, 18.176787, 16.398878, 13.170673), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR2$studyDuration, collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$eventsNotAchieved[1, ], c(0, 0, 0, 0, 0, 0, 0), label = paste0("c(", paste0(resultsWithSSR2$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$eventsNotAchieved[2, ], c(0, 0, 0, 0, 0, 0, 0), label = paste0("c(", paste0(resultsWithSSR2$eventsNotAchieved[2, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$eventsNotAchieved[3, ], c(0, 0, 0, 0, 0, 0, 0), label = paste0("c(", paste0(resultsWithSSR2$eventsNotAchieved[3, ], collapse = ", "), ")"))
	...
	expect_equal(resultsWithSSR2$overallReject, c(0.04, 0.16, 0.37, 0.68, 0.88, 0.92, 0.98), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR2$overallReject, collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$rejectPerStage[1, ], c(0, 0, 0, 0.02, 0.04, 0.01, 0.08), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR2$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$rejectPerStage[2, ], c(0.01, 0.05, 0.08, 0.27, 0.36, 0.54, 0.71), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR2$rejectPerStage[2, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$rejectPerStage[3, ], c(0.03, 0.11, 0.29, 0.39, 0.48, 0.37, 0.19), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR2$rejectPerStage[3, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$futilityStop, c(0, 0, 0, 0, 0, 0, 0), label = paste0("c(", paste0(resultsWithSSR2$futilityStop, collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$futilityPerStage[1, ], c(0, 0, 0, 0, 0, 0, 0), label = paste0("c(", paste0(resultsWithSSR2$futilityPerStage[1, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$futilityPerStage[2, ], c(0, 0, 0, 0, 0, 0, 0), label = paste0("c(", paste0(resultsWithSSR2$futilityPerStage[2, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$earlyStop, c(0.01, 0.05, 0.08, 0.29, 0.4, 0.55, 0.79), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR2$earlyStop, collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$expectedNumberOfSubjects, c(799.983, 799.6335, 798.7768, 790.11401, 777.76145, 771.03106, 723.0996), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR2$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$expectedNumberOfEvents, c(401.86, 383.74, 349.47, 306.7, 267.64, 241.1, 183.79), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR2$expectedNumberOfEvents, collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_, NA_real_, NA_real_, NA_real_, NA_real_), label = paste0("c(", paste0(resultsWithSSR2$conditionalPowerAchieved[1, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$conditionalPowerAchieved[2, ], c(0.13442705, 0.17515425, 0.27216274, 0.37121019, 0.42163288, 0.51345413, 0.62679958), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR2$conditionalPowerAchieved[2, ], collapse = ", "), ")"))
	expect_equal(resultsWithSSR2$conditionalPowerAchieved[3, ], c(0.088787205, 0.13342075, 0.37806621, 0.51790868, 0.64116584, 0.64220287, 0.73456911), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSR2$conditionalPowerAchieved[3, ], collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
	...
	expect_equal(resultsWithoutSSR$overallReject, c(0.06, 0.09, 0.26, 0.36, 0.5, 0.62, 0.8), tolerance = 1e-07, label = paste0("c(", paste0(resultsWithoutSSR$overallReject, collapse = ", "), ")"))
...
test_that("'getSimulationSurvival': Confirm that event size racalcuation increases the Type I error rate, i.e., you have to use the combination test", {
	...
	expect_equal(resultsWithSSRGS$overallReject, 0.05, tolerance = 1e-07, label = paste0("c(", paste0(resultsWithSSRGS$overallReject, collapse = ", "), ")"))
...
test_that("'getSimulationSurvival': Confirm that the function works correctly with a user defined 'calcEventsFunction'", {
	...
	expect_equal(simResults$pi1, c(0.23662051, 0.25023841, 0.27674976), tolerance = 1e-07, label = paste0("c(", paste0(simResults$pi1, collapse = ", "), ")"))
	expect_equal(simResults$pi2, 0.30232367, tolerance = 1e-07, label = paste0("c(", paste0(simResults$pi2, collapse = ", "), ")"))
	expect_equal(simResults$median1, c(30.806541, 28.881133, 25.672118), tolerance = 1e-07, label = paste0("c(", paste0(simResults$median1, collapse = ", "), ")"))
	expect_equal(simResults$median2, 23.104906, tolerance = 1e-07, label = paste0("c(", paste0(simResults$median2, collapse = ", "), ")"))
	expect_equal(simResults$accrualIntensity, c(12.380952, 24.761905, 24.761905), tolerance = 1e-07, label = paste0("c(", paste0(simResults$accrualIntensity, collapse = ", "), ")"))
	expect_equal(simResults$lambda1, c(0.0225, 0.024, 0.027), tolerance = 1e-07, label = paste0("c(", paste0(simResults$lambda1, collapse = ", "), ")"))
	expect_equal(simResults$analysisTime[1, ], c(9.5194269, 8.9064508, 9.2223494), tolerance = 1e-07, label = paste0("c(", paste0(simResults$analysisTime[1, ], collapse = ", "), ")"))
	expect_equal(simResults$analysisTime[2, ], c(27.784104, 21.407573, 24.009249), tolerance = 1e-07, label = paste0("c(", paste0(simResults$analysisTime[2, ], collapse = ", "), ")"))
	expect_equal(simResults$analysisTime[3, ], c(55.740006, 35.109064, 70.374189), tolerance = 1e-07, label = paste0("c(", paste0(simResults$analysisTime[3, ], collapse = ", "), ")"))
	expect_equal(simResults$studyDuration, c(34.589904, 24.072277, 24.081522), tolerance = 1e-07, label = paste0("c(", paste0(simResults$studyDuration, collapse = ", "), ")"))
	expect_equal(simResults$eventsNotAchieved[1, ], c(0, 0, 0), label = paste0("c(", paste0(simResults$eventsNotAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simResults$eventsNotAchieved[2, ], c(0, 0, 0), label = paste0("c(", paste0(simResults$eventsNotAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simResults$eventsNotAchieved[3, ], c(0, 0, 0), label = paste0("c(", paste0(simResults$eventsNotAchieved[3, ], collapse = ", "), ")"))
	...
	expect_equal(simResults$overallReject, c(0.2, 0.2, 0.1), tolerance = 1e-07, label = paste0("c(", paste0(simResults$overallReject, collapse = ", "), ")"))
	expect_equal(simResults$rejectPerStage[1, ], c(0, 0, 0), label = paste0("c(", paste0(simResults$rejectPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simResults$rejectPerStage[2, ], c(0.1, 0, 0.1), tolerance = 1e-07, label = paste0("c(", paste0(simResults$rejectPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simResults$rejectPerStage[3, ], c(0.1, 0.2, 0), tolerance = 1e-07, label = paste0("c(", paste0(simResults$rejectPerStage[3, ], collapse = ", "), ")"))
	expect_equal(simResults$futilityStop, c(0.4, 0.5, 0.7), tolerance = 1e-07, label = paste0("c(", paste0(simResults$futilityStop, collapse = ", "), ")"))
	expect_equal(simResults$futilityPerStage[1, ], c(0.4, 0.4, 0.6), tolerance = 1e-07, label = paste0("c(", paste0(simResults$futilityPerStage[1, ], collapse = ", "), ")"))
	expect_equal(simResults$futilityPerStage[2, ], c(0, 0.1, 0.1), tolerance = 1e-07, label = paste0("c(", paste0(simResults$futilityPerStage[2, ], collapse = ", "), ")"))
	expect_equal(simResults$earlyStop, c(0.5, 0.5, 0.8), tolerance = 1e-07, label = paste0("c(", paste0(simResults$earlyStop, collapse = ", "), ")"))
	expect_equal(simResults$expectedNumberOfSubjects, c(235.32, 228.8, 218.48), tolerance = 1e-07, label = paste0("c(", paste0(simResults$expectedNumberOfSubjects, collapse = ", "), ")"))
	expect_equal(simResults$expectedNumberOfEvents, c(105.8, 87.8, 70.8), tolerance = 1e-07, label = paste0("c(", paste0(simResults$expectedNumberOfEvents, collapse = ", "), ")"))
	expect_equal(simResults$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_), label = paste0("c(", paste0(simResults$conditionalPowerAchieved[1, ], collapse = ", "), ")"))
	expect_equal(simResults$conditionalPowerAchieved[2, ], c(0.27873409, 0.6677915, 0.61838719), tolerance = 1e-07, label = paste0("c(", paste0(simResults$conditionalPowerAchieved[2, ], collapse = ", "), ")"))
	expect_equal(simResults$conditionalPowerAchieved[3, ], c(0.71007174, 0.61706552, 0.10609026), tolerance = 1e-07, label = paste0("c(", paste0(simResults$conditionalPowerAchieved[3, ], collapse = ", "), ")"))
	if (isTRUE(.isCompleteUnitTestSetEnabled())) {
