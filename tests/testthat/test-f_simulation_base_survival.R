...
## |  Creation date: 06 February 2023, 15:07:37
...
test_that("'getSimulationSurvival': configuration 11;", {
    ...
    ## Comparison of the results of SimulationResultsSurvival object 'simulationResults' with expected results
    expect_equal(simulationResults$pi1, c(0.3, 0.41433798, 0.51, 0.59003659), tolerance = 1e-07)
    expect_equal(simulationResults$median1, c(23.320299, 15.546866, 11.660149, 9.3281194), tolerance = 1e-07)
    expect_equal(simulationResults$median2, 23.320299, tolerance = 1e-07)
    expect_equal(simulationResults$accrualIntensity, 66.666667, tolerance = 1e-07)
    expect_equal(simulationResults$lambda1, c(0.029722912, 0.044584368, 0.059445824, 0.07430728), tolerance = 1e-07)
    expect_equal(simulationResults$lambda2, 0.029722912, tolerance = 1e-07)
    expect_equal(simulationResults$analysisTime[1, ], c(7.9897023, 7.1475519, 6.494373, 6.2294549), tolerance = 1e-07)
    expect_equal(simulationResults$analysisTime[2, ], c(17.213741, 10.852607, 9.0020285, 8.4492782), tolerance = 1e-07)
    expect_equal(simulationResults$analysisTime[3, ], c(28.255907, 20.342199, NA_real_, NA_real_), tolerance = 1e-07)
    expect_equal(simulationResults$studyDuration, c(28.255907, 12.725375, 7.9469034, 7.3207992), tolerance = 1e-07)
    expect_equal(simulationResults$eventsNotAchieved[1, ], c(0, 0, 0, 0))
    expect_equal(simulationResults$eventsNotAchieved[2, ], c(0, 0, 0, 0))
    expect_equal(simulationResults$eventsNotAchieved[3, ], c(0, 0, 0, 0))
    expect_equal(simulationResults$numberOfSubjects[1, ], c(532.2, 476.1, 432.4, 414.9), tolerance = 1e-07)
    expect_equal(simulationResults$numberOfSubjects[2, ], c(788.2, 681.33333, 599.66667, 562.8), tolerance = 1e-07)
    expect_equal(simulationResults$numberOfSubjects[3, ], c(800, 778.66667, NA_real_, NA_real_), tolerance = 1e-07)
    expect_equal(simulationResults$eventsPerStage[1, ], c(58, 58, 58, 58))
    expect_equal(simulationResults$eventsPerStage[2, ], c(162.8, 74.888889, 46, 44), tolerance = 1e-07)
    expect_equal(simulationResults$eventsPerStage[3, ], c(162.8, 132, NA_real_, NA_real_), tolerance = 1e-07)
    expect_equal(simulationResults$overallEventsPerStage[1, ], c(58, 58, 58, 58))
    expect_equal(simulationResults$overallEventsPerStage[2, ], c(220.8, 132.88889, 104, 102), tolerance = 1e-07)
    expect_equal(simulationResults$overallEventsPerStage[3, ], c(383.6, 264.88889, 104, 102), tolerance = 1e-07)
    expect_equal(simulationResults$iterations[1, ], c(10, 10, 10, 10))
    expect_equal(simulationResults$iterations[2, ], c(10, 9, 6, 5))
    expect_equal(simulationResults$iterations[3, ], c(10, 3, 0, 0))
    expect_equal(simulationResults$overallReject, c(0.1, 1, 1, 1), tolerance = 1e-07)
    expect_gte(object = simulationResults$overallReject[1], expected = 0)
    expect_gte(object = simulationResults$overallReject[2], expected = 0)
    expect_gte(object = simulationResults$overallReject[3], expected = 0)
    expect_gte(object = simulationResults$overallReject[4], expected = 0)
    ...
    expect_lte(object = simulationResults$overallReject[3], expected = 1)
    expect_lte(object = simulationResults$overallReject[4], expected = 1)
    expect_equal(simulationResults$rejectPerStage[1, ], c(0, 0.1, 0.4, 0.5), tolerance = 1e-07)
    expect_equal(simulationResults$rejectPerStage[2, ], c(0, 0.6, 0.6, 0.5), tolerance = 1e-07)
    expect_equal(simulationResults$rejectPerStage[3, ], c(0.1, 0.3, 0, 0), tolerance = 1e-07)
    expect_equal(simulationResults$futilityStop, c(0, 0, 0, 0))
    expect_equal(simulationResults$futilityPerStage[1, ], c(0, 0, 0, 0))
    expect_equal(simulationResults$futilityPerStage[2, ], c(0, 0, 0, 0))
    expect_equal(simulationResults$earlyStop, c(0, 0.7, 1, 1), tolerance = 1e-07)
    expect_equal(simulationResults$expectedNumberOfSubjects, c(800, 690.01, 532.76, 488.85), tolerance = 1e-07)
    expect_equal(simulationResults$expectedNumberOfEvents, c(383.6, 165, 85.6, 80), tolerance = 1e-07)
    expect_equal(simulationResults$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_, NA_real_))
    expect_equal(simulationResults$conditionalPowerAchieved[2, ], c(0.044313374, 0.60865148, 0.72866566, 0.82381582), tolerance = 1e-07)
    expect_equal(simulationResults$conditionalPowerAchieved[3, ], c(0.013892246, 0.84869906, NA_real_, NA_real_), tolerance = 1e-07)
    if (isTRUE(.isCompleteUnitTestSetEnabled())) {
        invisible(capture.output(expect_error(print(simulationResults), NA)))
        expect_output(print(simulationResults)$show())
        invisible(capture.output(expect_error(summary(simulationResults), NA)))
...
test_that("'getSimulationSurvival': Confirm that the function works correctly with a user defined 'calcEventsFunction'", {
    ...
    myCalcEventsFunction <- function(...,
        ...
        requiredStageEvents <-
            max(0, conditionalCriticalValue + qnorm(conditionalPower))^2 *
    ...
    expect_equal(simResults$pi1, c(0.23662051, 0.25023841, 0.27674976), tolerance = 1e-07)
    expect_equal(simResults$pi2, 0.30232367, tolerance = 1e-07)
    expect_equal(simResults$median1, c(30.806541, 28.881133, 25.672118), tolerance = 1e-07)
    expect_equal(simResults$median2, 23.104906, tolerance = 1e-07)
    expect_equal(simResults$accrualIntensity, c(12.380952, 24.761905, 24.761905), tolerance = 1e-07)
    expect_equal(simResults$lambda1, c(0.0225, 0.024, 0.027), tolerance = 1e-07)
    expect_equal(simResults$analysisTime[1, ], c(9.5194269, 8.9064508, 9.2223494), tolerance = 1e-07)
    expect_equal(simResults$analysisTime[2, ], c(27.784104, 21.407573, 24.009249), tolerance = 1e-07)
    expect_equal(simResults$analysisTime[3, ], c(55.740006, 35.109064, 70.374189), tolerance = 1e-07)
    expect_equal(simResults$studyDuration, c(34.589904, 24.072277, 24.081522), tolerance = 1e-07)
    expect_equal(simResults$eventsNotAchieved[1, ], c(0, 0, 0))
    expect_equal(simResults$eventsNotAchieved[2, ], c(0, 0, 0))
    expect_equal(simResults$eventsNotAchieved[3, ], c(0, 0, 0))
    expect_equal(simResults$numberOfSubjects[1, ], c(198.3, 183, 190.8), tolerance = 1e-07)
    expect_equal(simResults$numberOfSubjects[2, ], c(260, 256, 260))
    expect_equal(simResults$numberOfSubjects[3, ], c(260, 260, 260))
    expect_equal(simResults$eventsPerStage[1, ], c(20, 20, 20))
    expect_equal(simResults$eventsPerStage[2, ], c(85.333333, 64.833333, 77), tolerance = 1e-07)
    expect_equal(simResults$eventsPerStage[3, ], c(69.2, 57.8, 100), tolerance = 1e-07)
    expect_equal(simResults$overallEventsPerStage[1, ], c(20, 20, 20))
    expect_equal(simResults$overallEventsPerStage[2, ], c(105.33333, 84.833333, 97), tolerance = 1e-07)
    expect_equal(simResults$overallEventsPerStage[3, ], c(174.53333, 142.63333, 197), tolerance = 1e-07)
    expect_equal(simResults$iterations[1, ], c(10, 10, 10))
    expect_equal(simResults$iterations[2, ], c(6, 6, 4))
    expect_equal(simResults$iterations[3, ], c(5, 5, 2))
    expect_equal(simResults$overallReject, c(0.2, 0.2, 0.1), tolerance = 1e-07)
    expect_equal(simResults$rejectPerStage[1, ], c(0, 0, 0))
    expect_equal(simResults$rejectPerStage[2, ], c(0.1, 0, 0.1), tolerance = 1e-07)
    expect_equal(simResults$rejectPerStage[3, ], c(0.1, 0.2, 0), tolerance = 1e-07)
    expect_equal(simResults$futilityStop, c(0.4, 0.5, 0.7), tolerance = 1e-07)
    expect_equal(simResults$futilityPerStage[1, ], c(0.4, 0.4, 0.6), tolerance = 1e-07)
    expect_equal(simResults$futilityPerStage[2, ], c(0, 0.1, 0.1), tolerance = 1e-07)
    expect_equal(simResults$earlyStop, c(0.5, 0.5, 0.8), tolerance = 1e-07)
    expect_equal(simResults$expectedNumberOfSubjects, c(235.32, 228.8, 218.48), tolerance = 1e-07)
    expect_equal(simResults$expectedNumberOfEvents, c(105.8, 87.8, 70.8), tolerance = 1e-07)
    expect_equal(simResults$conditionalPowerAchieved[1, ], c(NA_real_, NA_real_, NA_real_))
    expect_equal(simResults$conditionalPowerAchieved[2, ], c(0.27873409, 0.6677915, 0.61838719), tolerance = 1e-07)
    expect_equal(simResults$conditionalPowerAchieved[3, ], c(0.71007174, 0.61706552, 0.10609026), tolerance = 1e-07)
    if (isTRUE(.isCompleteUnitTestSetEnabled())) {
        ...
        expect_equal(simResultsCodeBased$pi1, simResults$pi1, tolerance = 1e-05)
        expect_equal(simResultsCodeBased$pi2, simResults$pi2, tolerance = 1e-05)
        expect_equal(simResultsCodeBased$median1, simResults$median1, tolerance = 1e-05)
        expect_equal(simResultsCodeBased$median2, simResults$median2, tolerance = 1e-05)
        expect_equal(simResultsCodeBased$accrualIntensity, simResults$accrualIntensity, tolerance = 1e-05)
        expect_equal(simResultsCodeBased$lambda1, simResults$lambda1, tolerance = 1e-05)
        expect_equal(simResultsCodeBased$analysisTime, simResults$analysisTime, tolerance = 1e-05)
        expect_equal(simResultsCodeBased$studyDuration, simResults$studyDuration, tolerance = 1e-05)
        expect_equal(simResultsCodeBased$eventsNotAchieved, simResults$eventsNotAchieved, tolerance = 1e-05)
        expect_equal(simResultsCodeBased$numberOfSubjects, simResults$numberOfSubjects, tolerance = 1e-05)
        expect_equal(simResultsCodeBased$eventsPerStage, simResults$eventsPerStage, tolerance = 1e-05)
        expect_equal(simResultsCodeBased$overallEventsPerStage, simResults$overallEventsPerStage, tolerance = 1e-05)
        expect_equal(simResultsCodeBased$iterations, simResults$iterations, tolerance = 1e-05)
        expect_equal(simResultsCodeBased$overallReject, simResults$overallReject, tolerance = 1e-05)
        expect_equal(simResultsCodeBased$rejectPerStage, simResults$rejectPerStage, tolerance = 1e-05)
        expect_equal(simResultsCodeBased$futilityStop, simResults$futilityStop, tolerance = 1e-05)
        expect_equal(simResultsCodeBased$futilityPerStage, simResults$futilityPerStage, tolerance = 1e-05)
        expect_equal(simResultsCodeBased$earlyStop, simResults$earlyStop, tolerance = 1e-05)
        expect_equal(simResultsCodeBased$expectedNumberOfSubjects, simResults$expectedNumberOfSubjects, tolerance = 1e-05)
        expect_equal(simResultsCodeBased$expectedNumberOfEvents, simResults$expectedNumberOfEvents, tolerance = 1e-05)
        expect_equal(simResultsCodeBased$conditionalPowerAchieved, simResults$conditionalPowerAchieved, tolerance = 1e-05)
