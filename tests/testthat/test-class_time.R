...
test_that("Testing 'getPiecewiseSurvivalTime': list-wise definition", {
    ...
    pwSurvivalTime6 <- getPiecewiseSurvivalTime(
        piecewiseSurvivalTime = list("0 - <x" = 0.025),
        hazardRatio = 0.8, delayedResponseAllowed = TRUE
    )

    ## Comparison of the results of PiecewiseSurvivalTime object 'pwSurvivalTime6' with expected results
    expect_equal(pwSurvivalTime6$piecewiseSurvivalTime, 0, label = paste0("c(", paste0(pwSurvivalTime6$piecewiseSurvivalTime, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime6$lambda1, 0.02, tolerance = 1e-07, label = paste0("c(", paste0(pwSurvivalTime6$lambda1, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime6$lambda2, 0.025, tolerance = 1e-07, label = paste0("c(", paste0(pwSurvivalTime6$lambda2, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime6$hazardRatio, 0.8, tolerance = 1e-07, label = paste0("c(", paste0(pwSurvivalTime6$hazardRatio, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime6$pi1, NA_real_, label = paste0("c(", paste0(pwSurvivalTime6$pi1, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime6$pi2, NA_real_, label = paste0("c(", paste0(pwSurvivalTime6$pi2, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime6$median1, 34.657359, tolerance = 1e-07, label = paste0("c(", paste0(pwSurvivalTime6$median1, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime6$median2, 27.725887, tolerance = 1e-07, label = paste0("c(", paste0(pwSurvivalTime6$median2, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime6$eventTime, NA_real_, label = paste0("c(", paste0(pwSurvivalTime6$eventTime, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime6$kappa, 1, label = paste0("c(", paste0(pwSurvivalTime6$kappa, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime6$piecewiseSurvivalEnabled, FALSE, label = paste0("c(", paste0(pwSurvivalTime6$piecewiseSurvivalEnabled, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime6$delayedResponseAllowed, TRUE, label = paste0("c(", paste0(pwSurvivalTime6$delayedResponseAllowed, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime6$delayedResponseEnabled, FALSE, label = paste0("c(", paste0(pwSurvivalTime6$delayedResponseEnabled, collapse = ", "), ")"))
    if (isTRUE(.isCompleteUnitTestSetEnabled())) {
        ...
        expect_equal(pwSurvivalTime6CodeBased$piecewiseSurvivalTime, pwSurvivalTime6$piecewiseSurvivalTime, tolerance = 1e-07)
        expect_equal(pwSurvivalTime6CodeBased$lambda1, pwSurvivalTime6$lambda1, tolerance = 1e-07)
        expect_equal(pwSurvivalTime6CodeBased$lambda2, pwSurvivalTime6$lambda2, tolerance = 1e-07)
        expect_equal(pwSurvivalTime6CodeBased$hazardRatio, pwSurvivalTime6$hazardRatio, tolerance = 1e-07)
        expect_equal(pwSurvivalTime6CodeBased$pi1, pwSurvivalTime6$pi1, tolerance = 1e-07)
        expect_equal(pwSurvivalTime6CodeBased$pi2, pwSurvivalTime6$pi2, tolerance = 1e-07)
        expect_equal(pwSurvivalTime6CodeBased$median1, pwSurvivalTime6$median1, tolerance = 1e-07)
        expect_equal(pwSurvivalTime6CodeBased$median2, pwSurvivalTime6$median2, tolerance = 1e-07)
        expect_equal(pwSurvivalTime6CodeBased$eventTime, pwSurvivalTime6$eventTime, tolerance = 1e-07)
        expect_equal(pwSurvivalTime6CodeBased$kappa, pwSurvivalTime6$kappa, tolerance = 1e-07)
        expect_equal(pwSurvivalTime6CodeBased$piecewiseSurvivalEnabled, pwSurvivalTime6$piecewiseSurvivalEnabled, tolerance = 1e-07)
        expect_equal(pwSurvivalTime6CodeBased$delayedResponseAllowed, pwSurvivalTime6$delayedResponseAllowed, tolerance = 1e-07)
        expect_equal(pwSurvivalTime6CodeBased$delayedResponseEnabled, pwSurvivalTime6$delayedResponseEnabled, tolerance = 1e-07)
    ...
    ## Comparison of the results of PiecewiseSurvivalTime object 'pwSurvivalTime8' with expected results
    expect_equal(pwSurvivalTime8$piecewiseSurvivalTime, 0, label = paste0("c(", paste0(pwSurvivalTime8$piecewiseSurvivalTime, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime8$lambda1, 0.02, tolerance = 1e-07, label = paste0("c(", paste0(pwSurvivalTime8$lambda1, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime8$lambda2, 0.025, tolerance = 1e-07, label = paste0("c(", paste0(pwSurvivalTime8$lambda2, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime8$hazardRatio, 0.8, tolerance = 1e-07, label = paste0("c(", paste0(pwSurvivalTime8$hazardRatio, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime8$pi1, NA_real_, label = paste0("c(", paste0(pwSurvivalTime8$pi1, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime8$pi2, NA_real_, label = paste0("c(", paste0(pwSurvivalTime8$pi2, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime8$median1, 34.657359, tolerance = 1e-07, label = paste0("c(", paste0(pwSurvivalTime8$median1, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime8$median2, 27.725887, tolerance = 1e-07, label = paste0("c(", paste0(pwSurvivalTime8$median2, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime8$eventTime, NA_real_, label = paste0("c(", paste0(pwSurvivalTime8$eventTime, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime8$kappa, 1, label = paste0("c(", paste0(pwSurvivalTime8$kappa, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime8$piecewiseSurvivalEnabled, FALSE, label = paste0("c(", paste0(pwSurvivalTime8$piecewiseSurvivalEnabled, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime8$delayedResponseAllowed, FALSE, label = paste0("c(", paste0(pwSurvivalTime8$delayedResponseAllowed, collapse = ", "), ")"))
    expect_equal(pwSurvivalTime8$delayedResponseEnabled, FALSE, label = paste0("c(", paste0(pwSurvivalTime8$delayedResponseEnabled, collapse = ", "), ")"))
