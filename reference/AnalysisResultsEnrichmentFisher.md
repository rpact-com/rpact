...
Class for enrichment analysis results based on a Fisher combination test
design.
...
Fisher combination test design.
...
- `conditionalPowerSimulated`:
  ...
  The simulated conditional power, under the assumption of observed or
