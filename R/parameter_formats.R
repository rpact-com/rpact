...
C_PARAMETER_FORMAT_FUNCTIONS <- createDictionary("C_PARAMETER_FORMAT_FUNCTIONS", list(
    ...
    overallEstimates = ".formatMeans",
    overallStandardErrors = ".formatStDevs",
    overallDegreesOfFreedom = ".formatMeans",
    ...
    pi1 = ".formatRates",
    pi2 = ".formatRates",
    lambdaTreatment = ".formatRates",
    medianTreatment = ".formatRates",
    ...
    expectedStudyDurationH1 = ".formatTime", # deprecated
