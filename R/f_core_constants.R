...
C_DIRECTION_UPPER_SURVIVAL_DEFAULT <- FALSE
...
C_EXCEPTION_TYPE_ARGUMENT_OUT_OF_RANGE <- "Argument out of range: "
C_EXCEPTION_TYPE_ARGUMENT_LENGTH_OUT_OF_RANGE <- "Argument length out of range: "
C_EXCEPTION_TYPE_INDEX_OUT_OF_BOUNDS <- "Index out of bounds: "
C_EXCEPTION_TYPE_MISSING_ARGUMENT <- "Missing argument: "
C_EXCEPTION_TYPE_UNKNOWN_ARGUMENT <- "Unknown argument: "
...
#
# Constants rates and survival
#

C_PI_1_SAMPLE_SIZE_RATES_DEFAULT <- c(0.4, 0.5, 0.6)
C_PI_1_SAMPLE_SIZE_SURVIVAL_DEFAULT <- c(0.1, 0.2, 0.3)
C_PI_1_POWER_RATES_DEFAULT <- seq(0.2, 0.5, 0.1)
C_PI_1_POWER_SURVIVAL_DEFAULT <- seq(0.2, 0.5, 0.1)
C_PI_2_RATES_DEFAULT <- 0.2
C_PI_2_SURVIVAL_DEFAULT <- 0.5
...
C_RANGE_OF_HAZARD_RATIOS_DEFAULT <- seq(1, 0.4, -0.2)
C_STDEV_DEFAULT <- 1
