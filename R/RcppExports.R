...
.getSimulationSurvivalEnrichmentStageEventsCpp <- function(stage, directionUpper, conditionalPower, conditionalCriticalValue, plannedEvents, allocationRatioPlanned, selectedPopulations, thetaH0, thetaH1, overallEffects, minNumberOfEventsPerStage, maxNumberOfEventsPerStage) {
    .Call(`_rpact_getSimulationSurvivalEnrichmentStageEvents`, stage, directionUpper, conditionalPower, conditionalCriticalValue, plannedEvents, allocationRatioPlanned, selectedPopulations, thetaH0, thetaH1, overallEffects, minNumberOfEventsPerStage, maxNumberOfEventsPerStage)
}
...
.getSimulationSurvivalMultiArmStageEventsCpp <- function(stage, directionUpper, conditionalPower, conditionalCriticalValue, plannedEvents, allocationRatioPlanned, selectedArms, thetaH0, thetaH1, overallEffects, minNumberOfEventsPerStage, maxNumberOfEventsPerStage) {
    .Call(`_rpact_getSimulationSurvivalMultiArmStageEvents`, stage, directionUpper, conditionalPower, conditionalCriticalValue, plannedEvents, allocationRatioPlanned, selectedArms, thetaH0, thetaH1, overallEffects, minNumberOfEventsPerStage, maxNumberOfEventsPerStage)
}
