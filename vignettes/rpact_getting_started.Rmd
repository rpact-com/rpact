...
*	Sample size and power calculation for
    ...
    +	survival trials with
        - flexible survival time distributions
        -	user defined patient recruitment
    + count data    
*	Fixed sample size design and designs with interim analysis stages
*	Simulation tool for means, rates, and survival data
    +	Assessment of adaptive sample size/event number recalculations based on
        conditional power using predefined and user-defined formulas
    + Assessment of treatment selection rules in multi-arm trials
    + Assessment of adaptive strategies in population enrichment designs
*	Adaptive analysis for means, rates, and survival data
  + One- and two-armed trials testing a single hypothesis
  + Closed testing procedure for testing multiple hypotheses in 
