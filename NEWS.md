...
* `getSampleSizeMeans()`, `getPowerMeans()`, `getSimluationMeans()`: For two-armed trials, it is allowed to specify the standard deviations (`stDev`) separately, i.e., as vector with two elements. 
