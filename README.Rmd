...
- **rpact** is a comprehensive, validated^[The rpact validation documentation is
  ...
  R package for clinical trial planning, design, simulation, and analysis.

  It supports classic fixed designs, adaptive group sequential designs, sample
  size and power calculations, simulation-based operating characteristics, and
  confirmatory trial analysis with flexible interim decision rules.
